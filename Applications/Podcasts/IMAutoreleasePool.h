...
- (void)dealloc;	// IMP=0x00000001001ded20
- (void)increaseCount;	// IMP=0x00000001001dec8c
- (void)_resetPool;	// IMP=0x00000001001dec00
- (void)setTarget:(id)arg1 action:(SEL)arg2 context:(void *)arg3;	// IMP=0x00000001001debd8
- (id)init;	// IMP=0x00000001001deb48
