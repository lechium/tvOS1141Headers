...
- (void)resetAcceptedCredentials;	// IMP=0x0000000100061188
- (id)authenticationErrorsForTransaction:(id)arg1;	// IMP=0x0000000100061098
- (_Bool)shouldForceAuthenticationForTransaction:(id)arg1;	// IMP=0x0000000100061038
- (_Bool)isAuthenticationValidForTransaction:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100060f68
- (void)dealloc;	// IMP=0x0000000100060ee8
- (id)init;	// IMP=0x0000000100060e60
