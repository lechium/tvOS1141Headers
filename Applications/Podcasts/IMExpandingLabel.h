...
- (void).cxx_destruct;	// IMP=0x00000001002610fc
@property(nonatomic, getter=isScrollEnabled) _Bool scrollEnabled;
- (double)heightForWidth:(double)arg1;	// IMP=0x0000000100260ec8
- (void)moreButtonTapped:(id)arg1;	// IMP=0x0000000100260a40
- (void)layoutSubviews;	// IMP=0x000000010025fdbc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010025f9a8
- (id)_font;	// IMP=0x0000000100162b4c
- (unsigned long long)maximumNumberOfLinesThatFitHeight:(double)arg1;	// IMP=0x0000000100162af0
- (void)setMoreButtonFont:(id)arg1;	// IMP=0x00000001001629d4
- (void)setFont:(id)arg1;	// IMP=0x00000001001628b8
