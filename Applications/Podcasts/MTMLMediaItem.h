...
+ (_Bool)isMediaItemSyncedFromiTunes:(id)arg1;	// IMP=0x00000001000ab7c4
+ (id)propertiesForMediaItem;	// IMP=0x00000001000ab604
+ (_Bool)isMissingAssetForItem:(id)arg1;	// IMP=0x00000001000ab488
+ (_Bool)isMissingFilePathForItem:(id)arg1;	// IMP=0x00000001000ab424
+ (id)itemWithMPMediaItem:(id)arg1;	// IMP=0x00000001000aac2c
...
- (void).cxx_destruct;	// IMP=0x00000001000abb54
- (id)description;	// IMP=0x00000001000ab538
