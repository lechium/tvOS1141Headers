...
- (void).cxx_destruct;	// IMP=0x00000001001278c4
- (void)addCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000001001277e4
- (id)initWithProperties:(id)arg1;	// IMP=0x000000010012747c
- (id)init;	// IMP=0x000000010012746c
