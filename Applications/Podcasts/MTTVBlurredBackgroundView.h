...
- (void).cxx_destruct;	// IMP=0x000000010004720c
- (void)setupSubviews;	// IMP=0x0000000100047118
- (void)layoutSubviews;	// IMP=0x0000000100046f0c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100046eb4
