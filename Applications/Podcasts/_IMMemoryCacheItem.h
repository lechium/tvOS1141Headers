...
+ (id)cacheItemWithItem:(id)arg1 key:(id)arg2 cost:(unsigned long long)arg3;	// IMP=0x00000001001d0d90
...
- (id)description;	// IMP=0x00000001001d0ee0
- (void)dealloc;	// IMP=0x00000001001d0e7c
