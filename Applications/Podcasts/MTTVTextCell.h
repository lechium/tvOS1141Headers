...
- (void)textFieldDidEndEditing:(id)arg1;	// IMP=0x00000001000a3cd4
- (void)showEditTitleUI;	// IMP=0x00000001000a3b8c
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x00000001000a3a98
