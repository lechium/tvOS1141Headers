...
- (void).cxx_destruct;	// IMP=0x0000000100099a98
- (void)enumerateUnvisitedItemUuids:(CDUnknownBlockType)arg1;	// IMP=0x000000010009991c
- (void)_addDictionary:(id)arg1;	// IMP=0x00000001000997e8
- (void)addEntityToCache:(id)arg1;	// IMP=0x0000000100099798
- (void)_buildMap;	// IMP=0x0000000100099464
- (id)propertyDictionaryForSearchItem:(id)arg1;	// IMP=0x0000000100099230
- (id)initWithPredicate:(id)arg1 entityName:(id)arg2 ctx:(id)arg3 properties:(id)arg4 fetchProperties:(id)arg5;	// IMP=0x00000001000990cc
