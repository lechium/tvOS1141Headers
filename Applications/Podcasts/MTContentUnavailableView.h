...
+ (id)messageLabelWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000305f4
...
- (void).cxx_destruct;	// IMP=0x00000001000318e0
- (void)_sizeCategoryDidChange:(id)arg1;	// IMP=0x0000000100031718
- (void)_buttonClick;	// IMP=0x000000010003169c
- (void)layoutSubviews;	// IMP=0x00000001000312bc
- (void)dealloc;	// IMP=0x0000000100030990
- (id)initWithFrame:(struct CGRect)arg1 title:(id)arg2 message:(id)arg3;	// IMP=0x0000000100030798
- (id)initWithFrame:(struct CGRect)arg1 title:(id)arg2;	// IMP=0x0000000100030788
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100030778
