...
- (void).cxx_destruct;	// IMP=0x000000010018ddd0
- (void)didMoveToWindow;	// IMP=0x000000010018dbd4
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010018dbc8
- (void)layoutSubviews;	// IMP=0x000000010018da3c
- (void)updatePlaybackState;	// IMP=0x000000010018d8a0
- (void)_unregisterForNotifications;	// IMP=0x000000010018d7b0
- (void)_registerForNotifications;	// IMP=0x000000010018d6ac
@property(nonatomic) unsigned long long barsStyle;
@property(nonatomic) UIImage *image;
- (void)dealloc;	// IMP=0x000000010018d120
- (id)init;	// IMP=0x000000010018d0a0
