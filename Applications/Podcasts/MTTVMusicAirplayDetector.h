...
- (void).cxx_destruct;	// IMP=0x000000010015c3f0
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x000000010015c1cc
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000010015c04c
