...
- (void).cxx_destruct;	// IMP=0x00000001000eeb54
- (_Bool)canBecomeFocused;	// IMP=0x00000001000eea8c
- (double)_fixedSeedValueForBarIndex:(unsigned long long)arg1;	// IMP=0x00000001000eea68
- (double)_randomSeedValueForBar;	// IMP=0x00000001000eea30
- (double)_seedValueForBarIndex:(unsigned long long)arg1;	// IMP=0x00000001000ee9d4
- (void)_updateLevelAnimations;	// IMP=0x00000001000ee324
- (void)_reloadLevelViews;	// IMP=0x00000001000ee004
- (void)_removeAllAnimations:(_Bool)arg1;	// IMP=0x00000001000edd38
- (void)tintColorDidChange;	// IMP=0x00000001000edba0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000edb3c
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000001000ed9f0
- (void)layoutSubviews;	// IMP=0x00000001000ed7fc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000ed6b4
