...
- (void).cxx_destruct;	// IMP=0x00000001000df934
- (void)buttonTapped:(id)arg1;	// IMP=0x00000001000df838
- (void)layoutSubviews;	// IMP=0x00000001000df504
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000df1d8
