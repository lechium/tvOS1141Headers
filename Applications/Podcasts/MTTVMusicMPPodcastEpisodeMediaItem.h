...
+ (double)_playedThresholdTimeForDuration:(double)arg1;	// IMP=0x00000001000851d0
...
- (void).cxx_destruct;	// IMP=0x0000000100085328
- (void)performMediaItemMetadataTransactionWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000001000851b8
- (void)removeMediaItemMetadataForProperty:(id)arg1;	// IMP=0x00000001000851a0
- (void)setMediaItemMetadata:(id)arg1 forProperty:(id)arg2;	// IMP=0x0000000100085148
- (id)reportingDelegate;	// IMP=0x0000000100085140
- (_Bool)hasTrait:(id)arg1;	// IMP=0x00000001000850c8
- (_Bool)isEqualToMediaItem:(id)arg1;	// IMP=0x0000000100084fd4
- (id)mediaItemURL;	// IMP=0x0000000100084fcc
- (id)mediaItemMetadataForProperty:(id)arg1;	// IMP=0x0000000100084874
- (id)initWithPlayerResponseItem:(id)arg1;	// IMP=0x0000000100084864
- (id)initWithPlayerResponseItem:(id)arg1 mediaItemMetadata:(id)arg2;	// IMP=0x0000000100084728
