...
+ (double)cornerRadius;	// IMP=0x0000000100165a14
...
- (void).cxx_destruct;	// IMP=0x000000010016680c
- (void)_playButtonAction:(id)arg1;	// IMP=0x0000000100166598
- (void)_selectButtonAction:(id)arg1;	// IMP=0x000000010016650c
- (void)floatingContentView:(id)arg1 isTransitioningFromState:(unsigned long long)arg2 toState:(unsigned long long)arg3;	// IMP=0x00000001001664e4
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x000000010016644c
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100166354
- (struct CGRect)_moreLabelFrame;	// IMP=0x0000000100166074
- (id)_moreLabelExclusionPath;	// IMP=0x0000000100165fd8
- (void)_recomputeTextSizeIfNeeded;	// IMP=0x0000000100165e8c
- (void)_setNeedsTextSizeComputation;	// IMP=0x0000000100165e78
@property(nonatomic) unsigned long long maximumNumberOfLines;
@property(retain, nonatomic) NSAttributedString *descriptionText;
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x0000000100165998
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100165894
- (_Bool)canBecomeFocused;	// IMP=0x0000000100165888
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100165774
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000001001656cc
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000100165628
- (void)layoutSubviews;	// IMP=0x00000001001652b8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100164a20
