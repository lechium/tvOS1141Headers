...
+ (double)rightViewControllerTopMargin;	// IMP=0x0000000100081298
...
- (void).cxx_destruct;	// IMP=0x0000000100081508
- (void)setupChildViewControllers;	// IMP=0x00000001000812a4
- (void)showAddPodcastsUI;	// IMP=0x00000001000811e8
- (id)initWithStation:(id)arg1;	// IMP=0x00000001000810e8
