...
- (void).cxx_destruct;	// IMP=0x00000001001094c8
- (void)engine:(id)arg1 didResetQueueWithPlaybackContext:(id)arg2 error:(id)arg3;	// IMP=0x0000000100109074
- (void)engine:(id)arg1 willChangeToItem:(id)arg2 fromItem:(id)arg3;	// IMP=0x0000000100108f04
- (_Bool)_getStringForTitleLabel:(id *)arg1 subtitleLabel:(id *)arg2 forMediaItem:(id)arg3;	// IMP=0x0000000100108db8
- (void)_populatePlayerItem:(id)arg1 withMetadataFromMediaItem:(id)arg2;	// IMP=0x0000000100108784
- (id)_TVPPlaybackStateFromMCPPlayerState:(long long)arg1;	// IMP=0x0000000100108678
- (void)_playerPathChanged:(id)arg1;	// IMP=0x0000000100108610
- (void)_itemChanged:(id)arg1;	// IMP=0x0000000100108508
- (void)_itemReadyToPlay:(id)arg1;	// IMP=0x00000001001082e0
- (void)_loadStateChanged:(id)arg1;	// IMP=0x0000000100108278
- (void)_loadedDurationDidChange:(id)arg1;	// IMP=0x00000001001081d0
- (void)engine:(id)arg1 willResetQueueWithPlaybackIntent:(id)arg2;	// IMP=0x00000001001081cc
- (void)_sendNotificationForError:(id)arg1 avItem:(id)arg2;	// IMP=0x0000000100107fb4
- (void)engine:(id)arg1 didFailToPlayItem:(id)arg2 withError:(id)arg3;	// IMP=0x0000000100107eec
- (void)engine:(id)arg1 didFailToPlayFirstItem:(id)arg2;	// IMP=0x0000000100107e74
- (void)engineDidPauseForLeaseEnd:(id)arg1;	// IMP=0x0000000100107e1c
- (void)_updateElapsedTimeObserversWithDurationSnapshot:(CDStruct_fce57115)arg1;	// IMP=0x0000000100107c44
- (void)playQueue:(id)arg1 didChangeDurationSnapshot:(CDStruct_fce57115)arg2;	// IMP=0x0000000100107b00
- (void)playQueue:(id)arg1 didChangeAVPlayer:(id)arg2;	// IMP=0x0000000100107af0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000001001078cc
- (void)_setAVPlayer:(id)arg1;	// IMP=0x00000001001074ec
- (void)playQueue:(id)arg1 didChangeFromPlayState:(long long)arg2 toPlayState:(long long)arg3;	// IMP=0x000000010010723c
- (void)playQueue:(id)arg1 didChangePlayingItem:(id)arg2;	// IMP=0x000000010010722c
- (void)playQueue:(id)arg1 didUpdateQueue:(id)arg2;	// IMP=0x00000001001070c0
- (void)skipToNextChapterInDirection:(long long)arg1;	// IMP=0x00000001001070bc
- (_Bool)currentMediaItemSupportsScrubbingUsingPlayer;	// IMP=0x00000001001070b4
- (void)updateSubtitleOptions;	// IMP=0x00000001001070b0
- (void)setSelectedSubtitleOption:(id)arg1 setGlobalPreference:(_Bool)arg2;	// IMP=0x00000001001070ac
- (void)removeBoundaryTimeObserverWithToken:(id)arg1;	// IMP=0x00000001001070a4
...
- (void)invalidate;	// IMP=0x0000000100107034
- (void)removeWeakReferenceToVideoView:(id)arg1;	// IMP=0x0000000100107030
- (void)addWeakReferenceToVideoView:(id)arg1;	// IMP=0x000000010010702c
- (void)continueLoadingCurrentItem;	// IMP=0x0000000100107028
- (void)stopWithVolumeRampDuration:(double)arg1;	// IMP=0x000000010010701c
- (void)pauseWithVolumeRampDuration:(double)arg1;	// IMP=0x0000000100107010
- (void)pauseIgnoringDelegate:(_Bool)arg1;	// IMP=0x0000000100107004
- (void)playIgnoringDelegate:(_Bool)arg1;	// IMP=0x0000000100106ff8
- (id)addBoundaryTimeObserverForDates:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100106f74
- (id)addBoundaryTimeObserverForTimes:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100106f6c
- (void)changeMediaInDirection:(long long)arg1 reason:(id)arg2;	// IMP=0x0000000100106f60
- (void)changeMediaInDirection:(long long)arg1;	// IMP=0x0000000100106ee0
- (void)changeToMediaAtIndex:(unsigned long long)arg1 reason:(id)arg2;	// IMP=0x0000000100106e98
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_1b6d18a9)arg2 ignoreDelegate:(_Bool)arg3;	// IMP=0x0000000100106e8c
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_1b6d18a9)arg2;	// IMP=0x0000000100106e80
- (void)setElapsedTime:(double)arg1 orPlaybackDate:(id)arg2 withAVKitCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100106dd4
- (void)setElapsedTime:(double)arg1 precise:(_Bool)arg2;	// IMP=0x0000000100106dc8
- (void)setElapsedTime:(double)arg1;	// IMP=0x0000000100106d4c
@property(readonly, nonatomic) double elapsedTime;
- (void)_setCurrentMediaItem:(id)arg1;	// IMP=0x0000000100106a70
@property(retain, nonatomic) NSObject<TVPMediaItem> *currentMediaItem;
- (void)_setCurrentState:(id)arg1;	// IMP=0x00000001001066b0
- (void)stop;	// IMP=0x0000000100106480
- (void)play;	// IMP=0x0000000100106428
- (void)togglePlayPause;	// IMP=0x0000000100106398
- (void)scanWithRate:(double)arg1;	// IMP=0x00000001001062b0
- (void)pause;	// IMP=0x00000001001061a0
@property(nonatomic) __weak id <TVPPlaybackDelegate> delegate;
@property(readonly, nonatomic) double rate;
- (void)removeElapsedTimeObserverWithToken:(id)arg1;	// IMP=0x0000000100106084
- (id)addElapsedTimeObserver:(CDUnknownBlockType)arg1;	// IMP=0x0000000100105fe8
...
- (void)dealloc;	// IMP=0x0000000100105c98
- (id)init;	// IMP=0x0000000100105a60
- (id)initWithName:(id)arg1;	// IMP=0x00000001001059f4
