...
- (void).cxx_destruct;	// IMP=0x0000000100152c00
- (void)generator:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x0000000100152ad8
- (void)controllerDidChangeContent:(id)arg1;	// IMP=0x0000000100152920
- (void)controller:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x000000010015291c
- (id)_extraObjects;	// IMP=0x00000001001527f0
- (id)allObjects;	// IMP=0x000000010015274c
- (void)_initializeFrc;	// IMP=0x000000010015269c
