...
- (void).cxx_destruct;	// IMP=0x000000010015ac2c
- (void)generator:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x000000010015aa88
- (void)controllerDidChangeContent:(id)arg1;	// IMP=0x000000010015a8cc
- (_Bool)_hasResults;	// IMP=0x000000010015a844
- (id)_extraObjects;	// IMP=0x000000010015a77c
- (id)allObjects;	// IMP=0x000000010015a6b4
- (void)_initializeFrc;	// IMP=0x000000010015a608
