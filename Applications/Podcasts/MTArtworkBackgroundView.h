...
- (void).cxx_destruct;	// IMP=0x00000001000938f8
- (void)layoutSubviews;	// IMP=0x000000010009349c
- (void)_updateGradientColors;	// IMP=0x0000000100093324
- (id)_blurredImageForImage:(id)arg1;	// IMP=0x0000000100093288
- (id)initWithArtwork:(id)arg1 blendColor:(id)arg2;	// IMP=0x0000000100092eb8
- (id)init;	// IMP=0x0000000100092ea4
