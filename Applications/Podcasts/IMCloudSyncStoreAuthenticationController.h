...
- (void)resetAcceptedCredentials;	// IMP=0x000000010025aa7c
- (id)authenticationErrorsForTransaction:(id)arg1;	// IMP=0x000000010025a930
- (_Bool)shouldForceAuthenticationForTransaction:(id)arg1;	// IMP=0x000000010025a8d0
- (_Bool)isAuthenticationValidForTransaction:(id)arg1 error:(id *)arg2;	// IMP=0x000000010025a800
- (void)dealloc;	// IMP=0x000000010025a780
- (id)init;	// IMP=0x000000010025a6f8
