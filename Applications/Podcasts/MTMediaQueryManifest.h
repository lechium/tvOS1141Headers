...
- (void).cxx_destruct;	// IMP=0x00000001000590ec
- (void)controllerDidChangeContent:(id)arg1;	// IMP=0x000000010005900c
- (void)controller:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x0000000100058e78
- (void)_updateSortOrder;	// IMP=0x0000000100058c68
- (void)_processResults:(id)arg1;	// IMP=0x0000000100058a30
- (id)initWithMediaQuery:(id)arg1 initialItem:(id)arg2;	// IMP=0x000000010005846c
