...
- (void).cxx_destruct;	// IMP=0x000000010004110c
- (void)runQueryInContext:(id)arg1;	// IMP=0x0000000100040bfc
- (void)runQuery;	// IMP=0x0000000100040b80
- (void)runQueryWithPodcastPredicate:(id)arg1 episodePredicate:(id)arg2;	// IMP=0x0000000100040af8
- (id)init;	// IMP=0x0000000100040a84
