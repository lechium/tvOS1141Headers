...
- (void)scheduleStoreURLOperation:(id)arg1 data:(id)arg2;	// IMP=0x000000010007e4c0
- (void)postData:(id)arg1;	// IMP=0x000000010007e0dc
- (void)start;	// IMP=0x000000010007e098
- (void)dealloc;	// IMP=0x000000010007dfe0
- (id)initWithTransaction:(id)arg1;	// IMP=0x000000010007df78
