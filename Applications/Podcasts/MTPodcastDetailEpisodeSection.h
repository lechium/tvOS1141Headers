...
+ (id)dependentPropertyKeys;	// IMP=0x000000010008f5c4
...
- (void).cxx_destruct;	// IMP=0x000000010008fadc
- (void)controllerDidChangeContent:(id)arg1;	// IMP=0x000000010008f9d0
- (void)controllerWillChangeContent:(id)arg1;	// IMP=0x000000010008f988
- (void)controller:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(id)arg3 forChangeType:(unsigned long long)arg4 newIndexPath:(id)arg5;	// IMP=0x000000010008f88c
- (unsigned long long)indexOfEpisode:(id)arg1;	// IMP=0x000000010008f7e4
- (id)episodes;	// IMP=0x000000010008f790
- (void)loadData;	// IMP=0x000000010008f784
- (void)initializeFrc;	// IMP=0x000000010008f3d8
