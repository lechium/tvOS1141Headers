...
- (void).cxx_destruct;	// IMP=0x0000000100088fd4
@property(readonly, copy) NSString *description;
- (void)populateEpisodeDictionary;	// IMP=0x00000001000888c4
- (void)enumerateValuesForProperties:(id)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000100088704
