...
+ (id)playlistWithMPPlaylist:(id)arg1;	// IMP=0x00000001000a5148
...
- (void).cxx_destruct;	// IMP=0x00000001000a58ac
- (id)description;	// IMP=0x00000001000a5694
- (_Bool)isEmpty;	// IMP=0x00000001000a54d0
- (id)children;	// IMP=0x00000001000a54c0
- (void)addChild:(id)arg1;	// IMP=0x00000001000a543c
