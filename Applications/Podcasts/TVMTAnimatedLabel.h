...
- (void).cxx_destruct;	// IMP=0x00000001000604bc
- (void)_applicationDidBecomeActiveNotification:(id)arg1;	// IMP=0x0000000100060324
- (void)_applicationWillResignActiveNotification:(id)arg1;	// IMP=0x00000001000602cc
- (void)setMarqueeRunning:(_Bool)arg1;	// IMP=0x00000001000602c0
- (void)setMarqueeEnabled:(_Bool)arg1;	// IMP=0x00000001000602bc
- (void)_startMarqueeIfNeeded;	// IMP=0x000000010005ebd4
- (_Bool)_shouldCycle;	// IMP=0x000000010005eb84
- (void)_clearLabelTextContents;	// IMP=0x000000010005e9c4
- (void)_prepareNextMarquee;	// IMP=0x000000010005e9ac
- (void)_nextAttributedString;	// IMP=0x000000010005e454
- (id)_imageForText:(_Bool)arg1;	// IMP=0x000000010005e25c
- (void)drawTextInRect:(struct CGRect)arg1;	// IMP=0x000000010005e05c
- (void)stopAndResetScrollWithDuration:(double)arg1;	// IMP=0x000000010005d8e8
- (void)stopAnimatingWithoutResetWithDuration:(double)arg1;	// IMP=0x000000010005d858
- (void)stopAnimating;	// IMP=0x000000010005d79c
- (void)setNeedsDisplay;	// IMP=0x000000010005d404
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000010005d32c
- (void)_clearAttributedStrings;	// IMP=0x000000010005d198
- (void)setAttributedText:(id)arg1;	// IMP=0x000000010005d0d8
- (void)setText:(id)arg1;	// IMP=0x000000010005d04c
- (void)dealloc;	// IMP=0x000000010005cfd4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010005cd20
