...
- (id)description;	// IMP=0x000000010024dec0
- (id)userInfoValueForKey:(id)arg1;	// IMP=0x000000010024de58
- (void)setUserInfoValue:(id)arg1 forKey:(id)arg2;	// IMP=0x000000010024ddb0
- (void)dealloc;	// IMP=0x000000010024dce8
- (id)initWithType:(int)arg1 domain:(id)arg2 URL:(id)arg3 keys:(id)arg4;	// IMP=0x000000010024dc20
