...
- (void).cxx_destruct;	// IMP=0x0000000100096ef8
- (void)continueLoadingCurrentItem;	// IMP=0x0000000100096b2c
- (void)_setSelectedSubtitleOption:(id)arg1 userOverridesSystemSubtitleSettings:(_Bool)arg2;	// IMP=0x00000001000965ac
...
- (void)setSelectedSubtitleOption:(id)arg1 setGlobalPreference:(_Bool)arg2;	// IMP=0x0000000100096590
- (id)fetchSubtitleOptions;	// IMP=0x0000000100096044
@property(readonly, nonatomic) NSArray *subtitleOptions; // @synthesize subtitleOptions=_subtitleOptions;
- (void)updateSubtitleOptionsAndSelection;	// IMP=0x0000000100095f98
- (void)updateSubtitleOptions;	// IMP=0x0000000100095f24
- (void)beginLoadingSubtitleOptions;	// IMP=0x0000000100095bf4
- (void)postPlaybackStateChangeNotificationWithOldState:(id)arg1;	// IMP=0x0000000100095ab4
- (id)currentPlayingItem;	// IMP=0x0000000100095a60
- (id)playerController;	// IMP=0x0000000100095a4c
- (id)manifest;	// IMP=0x00000001000959f8
...
- (void)removeWeakReferenceToVideoView:(id)arg1;	// IMP=0x00000001000958d0
- (void)addWeakReferenceToVideoView:(id)arg1;	// IMP=0x00000001000958b0
- (void)_updateVideoViewsWithAVPlayer:(id)arg1;	// IMP=0x00000001000955fc
- (void)setCurrentMediaItemPresentationSize:(struct CGSize)arg1;	// IMP=0x0000000100095568
- (_Bool)currentMediaItemSupportsScrubbingUsingPlayer;	// IMP=0x0000000100095560
...
- (void)setElapsedTime:(double)arg1;	// IMP=0x000000010009512c
- (void)setElapsedTime:(double)arg1 precise:(_Bool)arg2;	// IMP=0x0000000100095120
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_1b6d18a9)arg2;	// IMP=0x0000000100095114
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_1b6d18a9)arg2 ignoreDelegate:(_Bool)arg3;	// IMP=0x0000000100095108
- (void)removeElapsedTimeObserverWithToken:(id)arg1;	// IMP=0x000000010009509c
- (void)removeBoundaryTimeObserverWithToken:(id)arg1;	// IMP=0x0000000100095098
- (id)addBoundaryTimeObserverForTimes:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100095090
- (id)addBoundaryTimeObserverForDates:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100095088
- (id)addElapsedTimeObserver:(CDUnknownBlockType)arg1;	// IMP=0x0000000100094fa8
@property(readonly, nonatomic) double rate; // @synthesize rate=_rate;
- (void)scanWithRate:(double)arg1;	// IMP=0x0000000100094e94
- (void)changeMediaInDirection:(long long)arg1;	// IMP=0x0000000100094dc0
- (void)changeMediaInDirection:(long long)arg1 reason:(id)arg2;	// IMP=0x0000000100094db4
- (void)stopWithVolumeRampDuration:(double)arg1;	// IMP=0x0000000100094da8
- (void)pauseWithVolumeRampDuration:(double)arg1;	// IMP=0x0000000100094d9c
- (void)skipToNextChapterInDirection:(long long)arg1;	// IMP=0x0000000100094d1c
- (void)stop;	// IMP=0x0000000100094cdc
- (void)pauseIgnoringDelegate:(_Bool)arg1;	// IMP=0x0000000100094cd0
- (void)pause;	// IMP=0x0000000100094c90
- (void)togglePlayPause;	// IMP=0x0000000100094c50
- (void)playIgnoringDelegate:(_Bool)arg1;	// IMP=0x0000000100094c44
- (void)play;	// IMP=0x0000000100094c04
- (void)_updatePlaylist;	// IMP=0x0000000100094af0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100094a78
- (void)_subtitleSettingsDidChange;	// IMP=0x0000000100094a1c
- (void)_durationAvailable;	// IMP=0x00000001000949d8
- (void)_mediaServicesDidReset;	// IMP=0x000000010009494c
- (void)_mediaServicesWillReset;	// IMP=0x0000000100094938
- (void)_loadedDurationDidChange;	// IMP=0x00000001000948f4
- (void)_mediaItemPresentationSizeDidChange;	// IMP=0x0000000100094878
- (void)_rateDidChange;	// IMP=0x0000000100094868
- (void)_mediaItemStatusDidChange;	// IMP=0x000000010009485c
- (void)_loadStateChanged;	// IMP=0x00000001000947f4
- (void)_periodicUpdate;	// IMP=0x000000010009461c
- (void)_manifestDidChange;	// IMP=0x0000000100094610
- (void)_stateDidChange;	// IMP=0x0000000100094580
- (void)_stateWillChange;	// IMP=0x0000000100094534
- (void)_mediaItemDidChange;	// IMP=0x00000001000943d8
- (void)_mediaItemWillChange;	// IMP=0x000000010009432c
- (void)invalidate;	// IMP=0x0000000100094328
- (void)dealloc;	// IMP=0x0000000100094204
- (id)initWithPlayer:(id)arg1;	// IMP=0x00000001000939fc
- (id)initWithName:(id)arg1;	// IMP=0x000000010009399c
