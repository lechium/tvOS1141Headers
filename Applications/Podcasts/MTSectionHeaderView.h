...
+ (id)font;	// IMP=0x00000001001b6ac4
+ (double)height;	// IMP=0x00000001001b6a18
...
- (void).cxx_destruct;	// IMP=0x00000001001b78a0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001001b7750
- (void)layoutSubviews;	// IMP=0x00000001001b72cc
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001001b71fc
@property(retain, nonatomic) NSString *backdropGroupName;
- (void)_updateBlurEffects;	// IMP=0x00000001001b6e18
- (void)prepareForReuse;	// IMP=0x00000001001b6d84
- (void)_configureSubviews;	// IMP=0x00000001001b6b60
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001001b6ae4
