...
+ (id)deleteAllContentInCtx:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000f7f48
+ (id)createOrUpdateUPPMetadataFromUPPRecord:(id)arg1 inCtx:(id)arg2;	// IMP=0x00000001000f7db0
+ (id)createOrUpdateUPPMetadataFromUPPMediaItem:(id)arg1 inCtx:(id)arg2;	// IMP=0x00000001000f7cf8
