...
- (void).cxx_destruct;	// IMP=0x000000010020f16c
- (id)description;	// IMP=0x000000010020ee68
@property(readonly, nonatomic) UIImage *artwork;
- (unsigned long long)hash;	// IMP=0x000000010020e994
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010020e6c4
