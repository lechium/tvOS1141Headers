...
- (void)_clearCachedValues;	// IMP=0x000000010007d150
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010007d080
- (struct CGRect)textRectForBounds:(struct CGRect)arg1 limitedToNumberOfLines:(long long)arg2;	// IMP=0x000000010007cf40
- (void)setBaselineAdjustment:(long long)arg1;	// IMP=0x000000010007cef0
- (void)setAdjustsFontSizeToFitWidth:(_Bool)arg1;	// IMP=0x000000010007cea0
- (void)setNumberOfLines:(long long)arg1;	// IMP=0x000000010007ce50
- (void)setLineBreakMode:(long long)arg1;	// IMP=0x000000010007ce00
- (void)setFont:(id)arg1;	// IMP=0x000000010007cdb0
- (void)setText:(id)arg1;	// IMP=0x000000010007cd60
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010007cc98
