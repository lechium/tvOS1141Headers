...
+ (id)groupWithTitle:(id)arg1 footerText:(id)arg2 settingsHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100122bac
+ (id)groupWithTitle:(id)arg1 footerText:(id)arg2 settings:(id)arg3;	// IMP=0x00000001001229e4
...
- (void).cxx_destruct;	// IMP=0x0000000100122e4c
