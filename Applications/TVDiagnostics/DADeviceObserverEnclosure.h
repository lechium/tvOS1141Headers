...
- (void)oneshotWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100003a08
- (void)end;	// IMP=0x0000000100003948
- (void)begin;	// IMP=0x00000001000036d4
- (id)initWithObserver:(id)arg1 delegate:(id)arg2;	// IMP=0x00000001000035f4
