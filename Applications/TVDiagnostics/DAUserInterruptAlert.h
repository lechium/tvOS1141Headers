...
- (void).cxx_destruct;	// IMP=0x000000010000ae90
- (void)activate;	// IMP=0x000000010000ad28
- (id)initWithSuiteName:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010000ac70
