...
@interface DADeviceState : NSObject <NSCopying, NSSecureCoding>
{
    ...
    NSArray *_history;	// 96 = 0x60
    NSArray *_errors;	// 104 = 0x68
    NSNumber *_timestamp;	// 112 = 0x70
}

+ (_Bool)supportsSecureCoding;	// IMP=0x000000010000ded8
...
- (void).cxx_destruct;	// IMP=0x000000010000f400
- (void)_sendChangeNotification;	// IMP=0x000000010000f114
- (void)_sendChangeNotificationIfNeeded;	// IMP=0x000000010000f0f4
- (id)_stringForPhase:(long long)arg1;	// IMP=0x000000010000f04c
- (id)description;	// IMP=0x000000010000ee70
- (void)removeErrorCodes:(id)arg1;	// IMP=0x000000010000ebb4
- (void)removeErrorCode:(long long)arg1;	// IMP=0x000000010000eb28
- (void)addErrorCode:(long long)arg1 userInfo:(id)arg2;	// IMP=0x000000010000ea10
- (void)updateWithDeviceState:(id)arg1;	// IMP=0x000000010000e7d8
- (void)transactionWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000010000e74c
- (_Bool)object:(id)arg1 isEqualToObject:(id)arg2;	// IMP=0x000000010000e6f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000dee0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010000dc24
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010000d720
- (id)initWithSerialNumber:(id)arg1 attributes:(id)arg2;	// IMP=0x000000010000d680
- (id)init;	// IMP=0x000000010000d4e4
