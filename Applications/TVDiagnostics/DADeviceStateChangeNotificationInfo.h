...
+ (id)infoWithChangedProperties:(unsigned long long)arg1 snapshot:(id)arg2;	// IMP=0x000000010000d3b4
...
- (void).cxx_destruct;	// IMP=0x000000010000d4d0
- (id)initWithChangedProperties:(unsigned long long)arg1 snapshot:(id)arg2;	// IMP=0x000000010000d420
