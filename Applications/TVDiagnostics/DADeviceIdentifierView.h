...
- (void).cxx_destruct;	// IMP=0x0000000100010ce8
- (void)setHeight;	// IMP=0x0000000100010b68
- (void)setHidden:(_Bool)arg1;	// IMP=0x0000000100010b18
- (void)updateConstraints;	// IMP=0x0000000100010268
- (void)updateWithDeviceState:(id)arg1;	// IMP=0x00000001000101d0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010000feec
