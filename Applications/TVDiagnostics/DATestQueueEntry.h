...
+ (id)queueEntryWithAttributes:(id)arg1 parameters:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000010000f574
...
- (void).cxx_destruct;	// IMP=0x000000010000f91c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010000f864
- (_Bool)isEqualToTestQueueEntry:(id)arg1;	// IMP=0x000000010000f778
- (unsigned long long)hash;	// IMP=0x000000010000f704
- (id)initWithAttributes:(id)arg1 parameters:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000010000f618
