...
+ (id)acceptableValueClasses;	// IMP=0x0000000100016f30
+ (id)sessionSettingsWithDictionary:(id)arg1;	// IMP=0x0000000100016a14
...
- (void).cxx_destruct;	// IMP=0x00000001000173c8
- (id)description;	// IMP=0x0000000100017254
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000171cc
- (_Bool)isEqualToSessionSettings:(id)arg1;	// IMP=0x0000000100017098
- (id)dictionary;	// IMP=0x0000000100016d88
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000100016a88
- (id)init;	// IMP=0x0000000100016a78
