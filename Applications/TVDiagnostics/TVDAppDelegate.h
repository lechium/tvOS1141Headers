...
- (void).cxx_destruct;	// IMP=0x00000001000158f8
- (void)exitApplication;	// IMP=0x0000000100015820
- (void)handleCloseApplicationEvent;	// IMP=0x0000000100015808
- (void)allowApplicationBackgrounding:(_Bool)arg1;	// IMP=0x00000001000157fc
- (void)applicationDidEnterBackground:(id)arg1;	// IMP=0x00000001000157c0
- (_Bool)application:(id)arg1 openURL:(id)arg2 sourceApplication:(id)arg3 annotation:(id)arg4;	// IMP=0x0000000100015750
- (_Bool)application:(id)arg1 didFinishLaunchingWithOptions:(id)arg2;	// IMP=0x00000001000155d4
