...
+ (id)namedLayerStackWithImage:(id)arg1 cornerRadiusFlatImage:(id)arg2 decodeLayerImagesImmediately:(_Bool)arg3;	// IMP=0x0000000100010204
+ (id)namedLayerStackWithImage:(id)arg1 cornerRadiusFlatImage:(id)arg2;	// IMP=0x000000010001019c
+ (id)namedLayerStackWithLayers:(id)arg1 cornerRadiusFlatImage:(id)arg2 radiosityImage:(id)arg3;	// IMP=0x00000001000100b4
+ (id)namedLayerStackWithLayers:(id)arg1 cornerRadiusFlatImage:(id)arg2;	// IMP=0x000000010001004c
+ (id)namedLayerStackProxyFromLayerStack:(id)arg1 layers:(id)arg2 cornerRadiusFlatImage:(id)arg3;	// IMP=0x000000010000ff60
+ (id)namedLayerStackProxyFromLayerStack:(id)arg1 cornerRadiusFlatImage:(id)arg2;	// IMP=0x000000010000feac
...
- (id)_init;	// IMP=0x000000010000fe78
- (id)init;	// IMP=0x000000010000fe60
