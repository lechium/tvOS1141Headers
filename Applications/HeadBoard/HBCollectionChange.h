...
- (void).cxx_destruct;	// IMP=0x00000001000934e8
- (id)description;	// IMP=0x0000000100093348
- (id)init;	// IMP=0x0000000100093330
- (id)initWithChangeKind:(unsigned long long)arg1 sourceIndexes:(id)arg2 destinationIndexes:(id)arg3;	// IMP=0x0000000100093250
