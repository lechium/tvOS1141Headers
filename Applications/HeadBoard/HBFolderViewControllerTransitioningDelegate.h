...
- (void)_cleanup;	// IMP=0x0000000100041150
- (_Bool)_isItemTransition;	// IMP=0x0000000100041114
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x0000000100040e38
- (id)animationControllerForPresentedController:(id)arg1 presentingController:(id)arg2 sourceController:(id)arg3;	// IMP=0x0000000100040ae8
