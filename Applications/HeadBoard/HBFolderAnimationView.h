...
- (void).cxx_destruct;	// IMP=0x0000000100053790
- (void)_updateWithCurrentStyle;	// IMP=0x00000001000533e8
- (void)_updateImageViews;	// IMP=0x00000001000530d4
@property(readonly, nonatomic) struct CGSize imageSize;
- (void)layoutSubviews;	// IMP=0x0000000100052b68
- (id)initWithConfiguration:(id)arg1;	// IMP=0x00000001000529b0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100052948
