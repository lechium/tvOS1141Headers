...
+ (id)_font;	// IMP=0x000000010002e930
+ (struct CGSize)sizeForString:(id)arg1;	// IMP=0x000000010002e6d0
@property(nonatomic) __weak UIVisualEffectView *vibracyView; // @synthesize vibracyView=_vibracyView;
@property(retain, nonatomic) UILabel *label; // @synthesize label=_label;
- (void).cxx_destruct;	// IMP=0x000000010002ebbc
@property(copy, nonatomic) NSString *title;
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x000000010002e418
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010002e0e0
