...
- (void).cxx_destruct;	// IMP=0x000000010000e4fc
- (void)_generateUninstallConfirmation;	// IMP=0x000000010000d9c4
- (void)_completeUninstallWillRemove:(_Bool)arg1;	// IMP=0x000000010000d928
- (void)cancel;	// IMP=0x000000010000d8c8
- (void)startWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010000d42c
@property(readonly, nonatomic) _Bool finishedApplicationRemovalConfirmation;
- (id)initWithApplication:(id)arg1 parentViewController:(id)arg2;	// IMP=0x000000010000d308
