...
+ (id)sharedThermalMonitor;	// IMP=0x000000010002b418
...
- (void)_updateThermalShutdownState;	// IMP=0x000000010002b674
- (void)dealloc;	// IMP=0x000000010002b614
- (id)init;	// IMP=0x000000010002b498
