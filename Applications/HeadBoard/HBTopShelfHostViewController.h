...
- (void).cxx_destruct;	// IMP=0x0000000100038320
- (void)_configureBannerImageForUserInterfaceStyle:(long long)arg1;	// IMP=0x0000000100038194
- (id)viewsForAnimator:(id)arg1;	// IMP=0x0000000100037f78
- (void)_bubbleAnimatorAnimatingDidChange:(id)arg1;	// IMP=0x0000000100037e54
- (void)viewControllerContentAvailableDidChange:(id)arg1;	// IMP=0x0000000100037dbc
- (void)_setViewController:(id)arg1 withAnimationDirection:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000374b0
- (void)setViewController:(id)arg1 withAnimationDirection:(long long)arg2;	// IMP=0x000000010003721c
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100037198
- (void)viewDidLayoutSubviews;	// IMP=0x00000001000370dc
- (void)viewDidLoad;	// IMP=0x0000000100036f78
- (void)dealloc;	// IMP=0x0000000100036ea0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000100036cf4
