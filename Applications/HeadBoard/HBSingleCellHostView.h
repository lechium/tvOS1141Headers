...
- (void).cxx_destruct;	// IMP=0x000000010000ee38
- (id)collectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2;	// IMP=0x000000010000ecd8
- (long long)collectionView:(id)arg1 numberOfItemsInSection:(long long)arg2;	// IMP=0x000000010000ecd0
- (long long)numberOfSectionsInCollectionView:(id)arg1;	// IMP=0x000000010000ecc8
- (id)indexPathForPreferredFocusedViewInCollectionView:(id)arg1;	// IMP=0x000000010000ecac
- (id)preferredFocusEnvironments;	// IMP=0x000000010000ec08
- (id)initWithItem:(id)arg1;	// IMP=0x000000010000e874
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010000e7cc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010000e72c
- (id)init;	// IMP=0x000000010000e68c
