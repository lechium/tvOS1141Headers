...
- (void).cxx_destruct;	// IMP=0x0000000100064518
- (void)_exitIdleMode;	// IMP=0x00000001000642b4
- (void)_enterIdleMode;	// IMP=0x0000000100063ecc
- (void)_updateWithCurrentUserInterfaceStyle;	// IMP=0x0000000100063db8
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100063d00
- (void)dealloc;	// IMP=0x0000000100063c24
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100063acc
