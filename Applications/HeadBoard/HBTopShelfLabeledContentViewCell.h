...
- (void).cxx_destruct;	// IMP=0x00000001000638b8
- (double)_maxTitleWidthWithFocus:(_Bool)arg1;	// IMP=0x0000000100063778
- (id)_animatedTitleLabel;	// IMP=0x000000010006376c
- (Class)_labelClass;	// IMP=0x0000000100063758
- (void)_updateTitleExpirationAppearance;	// IMP=0x00000001000633f0
- (void)_updateOverlayView;	// IMP=0x0000000100062ab8
- (void)layoutSubviews;	// IMP=0x0000000100062a68
- (void)setUnhighlightedTextColor:(id)arg1;	// IMP=0x00000001000616b4
- (id)unhighlightedTextColor;	// IMP=0x00000001000616a8
- (void)setHighlightedTextColor:(id)arg1;	// IMP=0x0000000100061674
- (id)highlightedTextColor;	// IMP=0x0000000100061668
- (void)setTitle:(id)arg1;	// IMP=0x0000000100061634
- (id)title;	// IMP=0x0000000100061628
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100061520
- (void)prepareForReuse;	// IMP=0x0000000100061468
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100060f1c
- (void)dealloc;	// IMP=0x0000000100060ebc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100060d6c
