...
- (void).cxx_destruct;	// IMP=0x00000001000062e4
- (id)decoratorIdentifier;	// IMP=0x0000000100006238
- (struct CGSize)expectedSize;	// IMP=0x000000010000622c
- (id)decorate:(id)arg1 scaledWithSize:(struct CGSize)arg2 croppedToFit:(_Bool)arg3;	// IMP=0x0000000100005c54
