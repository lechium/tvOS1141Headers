...
- (void).cxx_destruct;	// IMP=0x0000000100024e1c
- (id)_placeholderForUserInterfaceStyle:(long long)arg1;	// IMP=0x0000000100024d20
- (unsigned long long)numberOfItemsInCarouselView:(id)arg1;	// IMP=0x0000000100024cac
- (void)carouselView:(id)arg1 didPlayItemAtIndex:(unsigned long long)arg2;	// IMP=0x0000000100024a10
- (void)carouselView:(id)arg1 didSelectItemAtIndex:(unsigned long long)arg2;	// IMP=0x00000001000247a8
- (void)configureCell:(id)arg1 forItemAtIndex:(unsigned long long)arg2;	// IMP=0x0000000100024034
