...
+ (id)_iconImageForDeviceType:(unsigned long long)arg1 focused:(_Bool)arg2;	// IMP=0x000000010001b46c
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x0000000100019ff4
...
- (void).cxx_destruct;	// IMP=0x000000010001b6dc
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010001ae8c
- (unsigned long long)_controlStateForCell;	// IMP=0x000000010001ae08
- (void)_addInitialConstraints;	// IMP=0x000000010001a134
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0000000100019ab4
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000001000199c8
- (void)setSelected:(_Bool)arg1;	// IMP=0x00000001000199c4
- (void)updateConstraints;	// IMP=0x000000010001950c
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100019414
- (void)useFocusedAppearance;	// IMP=0x0000000100019400
- (void)prepareForReuse;	// IMP=0x00000001000193a4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100018be0
