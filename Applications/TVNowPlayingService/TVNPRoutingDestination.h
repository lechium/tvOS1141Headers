...
- (void).cxx_destruct;	// IMP=0x000000010000bc84
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x000000010000bb08
- (void)connectAndPair;	// IMP=0x000000010000bb04
- (void)togglePlayPause;	// IMP=0x000000010000bb00
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x000000010000bacc
- (id)init;	// IMP=0x000000010000bab4
