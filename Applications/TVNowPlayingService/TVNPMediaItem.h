...
- (void).cxx_destruct;	// IMP=0x0000000100012878
- (id)mediaItemMetadataForProperty:(id)arg1;	// IMP=0x00000001000126b0
- (void)replaceMediaItemMetadata:(id)arg1 forProperty:(id)arg2;	// IMP=0x0000000100012644
