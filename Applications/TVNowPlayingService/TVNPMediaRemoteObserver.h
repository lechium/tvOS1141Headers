...
- (void)_updateTimeStampFromAirtunesd:(id)arg1;	// IMP=0x000000010001d268
- (void)_deregisterAsObserver;	// IMP=0x000000010001d1ec
- (void)_registerAsObserver;	// IMP=0x000000010001d164
- (void)_nowPlayingInfoDidChange:(id)arg1;	// IMP=0x000000010001c9fc
- (void)metadataPlayerSentCommand:(unsigned int)arg1 withOptions:(id)arg2;	// IMP=0x000000010001c9e4
- (void)reset;	// IMP=0x000000010001c910
- (void)prepareForPlaybackWithEndpoint:(id)arg1;	// IMP=0x000000010001c624
- (void)prepareForPlayback;	// IMP=0x000000010001c5cc
