...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x00000001000081b8
...
- (void).cxx_destruct;	// IMP=0x000000010000b3a4
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x0000000100009eb4
- (void)_updateAvailableRoutes;	// IMP=0x00000001000098f4
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x0000000100009774
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x0000000100009768
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x000000010000975c
- (void)targetDestination:(id)arg1;	// IMP=0x0000000100009604
- (void)unpickRoute:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000100009250
- (void)pickRoute:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000100008ac4
- (void)_updateAllowsDestinationSelection;	// IMP=0x0000000100008a10
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x000000010000825c
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x000000010000824c
- (id)init;	// IMP=0x0000000100008238
