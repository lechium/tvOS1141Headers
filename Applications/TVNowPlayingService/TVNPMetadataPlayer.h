...
- (void).cxx_destruct;	// IMP=0x000000010000d4b0
- (void)_callElapsedTimeObserversDueToTimeJump:(_Bool)arg1;	// IMP=0x000000010000cecc
- (void)_fireElapsedTimeUpdate:(id)arg1;	// IMP=0x000000010000cebc
- (void)_updateElapsedTimeTimer;	// IMP=0x000000010000cdd4
@property(readonly, nonatomic) double elapsedTime;
- (float)_rateForState:(id)arg1;	// IMP=0x000000010000c9a4
...
- (_Bool)currentMediaItemSupportsScrubbingUsingPlayer;	// IMP=0x000000010000c6b0
- (void)setSelectedSubtitleOption:(id)arg1 setGlobalPreference:(_Bool)arg2;	// IMP=0x000000010000c6ac
- (void)updateSubtitleOptions;	// IMP=0x000000010000c6a8
- (void)removeBoundaryTimeObserverWithToken:(id)arg1;	// IMP=0x000000010000c6a4
- (id)addBoundaryTimeObserverForDates:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010000c69c
- (id)addBoundaryTimeObserverForTimes:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010000c694
- (void)removeElapsedTimeObserverWithToken:(id)arg1;	// IMP=0x000000010000c614
- (id)addElapsedTimeObserver:(CDUnknownBlockType)arg1;	// IMP=0x000000010000c540
- (void)skipToNextChapterInDirection:(long long)arg1;	// IMP=0x000000010000c4e0
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_198678f7)arg2 ignoreDelegate:(_Bool)arg3;	// IMP=0x000000010000c4d4
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_198678f7)arg2;	// IMP=0x000000010000c4c8
- (void)setElapsedTime:(double)arg1 precise:(_Bool)arg2;	// IMP=0x000000010000c4bc
- (void)setElapsedTime:(double)arg1;	// IMP=0x000000010000c3bc
- (void)stopWithVolumeRampDuration:(double)arg1;	// IMP=0x000000010000c3b0
- (void)stop;	// IMP=0x000000010000c320
- (void)scanWithRate:(double)arg1;	// IMP=0x000000010000c188
- (void)togglePlayPause;	// IMP=0x000000010000c140
- (void)pauseIgnoringDelegate:(_Bool)arg1;	// IMP=0x000000010000c134
- (void)pauseWithVolumeRampDuration:(double)arg1;	// IMP=0x000000010000c128
- (void)pause;	// IMP=0x000000010000c0e0
- (void)playIgnoringDelegate:(_Bool)arg1;	// IMP=0x000000010000c0d4
- (void)play;	// IMP=0x000000010000bfa4
- (void)continueLoadingCurrentItem;	// IMP=0x000000010000bfa0
- (void)changeMediaInDirection:(long long)arg1 reason:(id)arg2;	// IMP=0x000000010000bf14
- (void)changeMediaInDirection:(long long)arg1;	// IMP=0x000000010000bf04
- (void)setLastElapsedTime:(double)arg1 atTimestamp:(id)arg2;	// IMP=0x000000010000bea0
- (void)invalidate;	// IMP=0x000000010000be64
- (id)initWithName:(id)arg1;	// IMP=0x000000010000bd4c
- (id)init;	// IMP=0x000000010000bd3c
