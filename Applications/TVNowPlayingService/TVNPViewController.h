...
+ (id)_remoteViewControllerInterface;	// IMP=0x000000010001e140
+ (id)_exportedInterface;	// IMP=0x000000010001e024
...
- (void).cxx_destruct;	// IMP=0x000000010001e230
- (void)_menuPressed:(id)arg1;	// IMP=0x000000010001e15c
- (void)viewServiceEndPresentationWithOptions:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010001dcc8
- (void)viewServiceBeginPresentationWithOptions:(id)arg1;	// IMP=0x000000010001d5d8
- (void)viewDidLoad;	// IMP=0x000000010001d484
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000010001d3ac
