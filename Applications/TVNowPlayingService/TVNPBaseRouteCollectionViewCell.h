...
+ (id)_volumeImage:(_Bool)arg1;	// IMP=0x0000000100011544
+ (id)_iconImageForDeviceType:(unsigned long long)arg1 focused:(_Bool)arg2;	// IMP=0x00000001000111b4
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x000000010000f9e4
...
- (void).cxx_destruct;	// IMP=0x000000010001177c
- (id)_checkmarkImage:(_Bool)arg1 focused:(_Bool)arg2;	// IMP=0x0000000100011324
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100010b8c
- (unsigned long long)_controlStateForCell;	// IMP=0x0000000100010aec
- (void)_addInitialConstraints;	// IMP=0x000000010000fb24
- (void)volumeSliderValueChanged:(id)arg1;	// IMP=0x000000010000f9e0
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x000000010000f340
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010000f250
- (void)updateConstraints;	// IMP=0x000000010000ea48
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000010000e95c
- (void)setSelected:(_Bool)arg1;	// IMP=0x000000010000e958
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010000e860
- (void)prepareForReuse;	// IMP=0x000000010000e7dc
- (id)preferredFocusEnvironments;	// IMP=0x000000010000e734
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010000df24
