...
- (id)_indexPathForCurrentDestination;	// IMP=0x00000001000076b0
- (void)_presentVolumeBulletinForDestination:(id)arg1;	// IMP=0x0000000100006fd8
- (void)bulletinService:(id)arg1 didDismissBulletin:(id)arg2 withReason:(unsigned long long)arg3;	// IMP=0x0000000100006ecc
- (id)indexPathForPreferredFocusedViewInCollectionView:(id)arg1;	// IMP=0x0000000100006ec0
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x0000000100006978
- (struct CGPoint)collectionView:(id)arg1 targetContentOffsetForProposedContentOffset:(struct CGPoint)arg2;	// IMP=0x00000001000068e4
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000100006620
- (id)collectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2;	// IMP=0x00000001000064a0
- (long long)collectionView:(id)arg1 numberOfItemsInSection:(long long)arg2;	// IMP=0x0000000100006448
- (long long)numberOfSectionsInCollectionView:(id)arg1;	// IMP=0x0000000100006440
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100006048
- (_Bool)_ignoreVolumeChangesWhilePendingSelection;	// IMP=0x0000000100005f04
- (void)_showConnectionFailedAlertControllerForRoutingDestination:(id)arg1;	// IMP=0x0000000100005cbc
- (void)viewDidLayoutSubviews;	// IMP=0x000000010000577c
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00000001000056e8
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100005320
- (void)viewDidLoad;	// IMP=0x00000001000051c0
- (void)dealloc;	// IMP=0x0000000100005108
- (void)handleVolumeDown;	// IMP=0x0000000100004ee8
- (void)handleVolumeUp;	// IMP=0x0000000100004cc8
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2 options:(id)arg3 initialUIDProvider:(CDUnknownBlockType)arg4;	// IMP=0x0000000100004ad0
