...
+ (id)arrayChangeMove:(unsigned long long)arg1 toIndex:(unsigned long long)arg2;	// IMP=0x000000010001b978
+ (id)arrayChangeDelete:(id)arg1;	// IMP=0x000000010001b8c8
+ (id)arrayChangeInsert:(id)arg1;	// IMP=0x000000010001b81c
...
- (void).cxx_destruct;	// IMP=0x000000010001bc00
- (id)description;	// IMP=0x000000010001ba44
