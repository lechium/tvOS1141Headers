...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x000000010001f1c8
...
- (void).cxx_destruct;	// IMP=0x0000000100021f20
- (id)_placeholderArtwork;	// IMP=0x0000000100021d1c
- (void)_updateState;	// IMP=0x0000000100021b80
- (void)_updateAutomaticResponseLoading;	// IMP=0x0000000100021ab0
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x00000001000215a0
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0000000100021474
- (void)_updateMetadata;	// IMP=0x0000000100020014
- (void)_createRequestController;	// IMP=0x000000010001fb30
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x000000010001f8e4
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x000000010001f764
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x000000010001f384
- (void)playPause;	// IMP=0x000000010001f370
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x000000010001f30c
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010001f254
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x000000010001f16c
- (id)playerPath;	// IMP=0x000000010001f0b8
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x000000010001ef70
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x000000010001ecc4
