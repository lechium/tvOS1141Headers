...
- (void)incrementNumberOfUnsuccessfullyCompletedActions;	// IMP=0x000000010003a3a4
- (void)incrementNumberOfSuccessfullyCompletedActions;	// IMP=0x000000010003a308
- (void)incrementNumberOfStartedActions;	// IMP=0x000000010003a2d0
- (id)initWithAceCommand:(id)arg1 andCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100039f8c
