...
- (void).cxx_destruct;	// IMP=0x000000010001e0b8
- (_Bool)isActive;	// IMP=0x000000010001dfe0
- (void)viewDidLoad;	// IMP=0x000000010001dcec
- (void)loadView;	// IMP=0x000000010001dc38
- (id)init;	// IMP=0x000000010001dac8
