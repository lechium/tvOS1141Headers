...
+ (id)sirilandView;	// IMP=0x0000000100038be4
...
- (void).cxx_destruct;	// IMP=0x00000001000392e8
- (void)statusBarFrameDidChange;	// IMP=0x0000000100039178
- (void)layoutSubviews;	// IMP=0x0000000100038e70
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100038c0c
