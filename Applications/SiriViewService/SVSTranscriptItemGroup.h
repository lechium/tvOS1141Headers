...
- (void).cxx_destruct;	// IMP=0x0000000100046eb8
- (void)removeElementAtIndex:(long long)arg1;	// IMP=0x0000000100046d7c
- (void)shiftInsertionIndexesStartingAtIndex:(unsigned long long)arg1 by:(long long)arg2;	// IMP=0x0000000100046d64
- (void)replaceTranscriptItem:(id)arg1 withTranscriptItem:(id)arg2 cancelPresentationDelay:(_Bool)arg3;	// IMP=0x0000000100046bf4
- (unsigned long long)insertionIndexForTranscriptItem:(id)arg1;	// IMP=0x0000000100046a28
- (void)_presentationEligibilityConditionDidChange;	// IMP=0x00000001000467d8
- (unsigned long long)countByEnumeratingWithState:(CDStruct_70511ce9 *)arg1 objects:(id *)arg2 count:(unsigned long long)arg3;	// IMP=0x000000010004676c
@property(readonly, nonatomic) NSIndexSet *insertionIndexes;
@property(readonly, nonatomic) NSArray *transcriptItems;
- (id)description;	// IMP=0x00000001000464ac
- (id)init;	// IMP=0x0000000100046428
- (id)initWithTranscriptItems:(id)arg1 insertionIndexes:(id)arg2 provisional:(_Bool)arg3 waitsForConfirmation:(_Bool)arg4 presentationDelay:(double)arg5;	// IMP=0x0000000100046120
