...
+ (id)starkButtonWithType:(long long)arg1 title:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x000000010006423c
...
- (void).cxx_destruct;	// IMP=0x00000001000645d8
- (_Bool)canBecomeFirstResponder;	// IMP=0x0000000100064504
- (void)invokeConfirmationHandler:(id)arg1;	// IMP=0x00000001000644b0
- (void)setUserInteractionEnabled:(_Bool)arg1;	// IMP=0x0000000100064334
