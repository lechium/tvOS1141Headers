...
- (void).cxx_destruct;	// IMP=0x00000001000635bc
- (void)_setKeylineHidden:(id)arg1 hidden:(_Bool)arg2;	// IMP=0x0000000100063480
- (void)layoutSubviews;	// IMP=0x0000000100063148
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100063138
- (id)initWithFrame:(struct CGRect)arg1 collectionView:(id)arg2;	// IMP=0x0000000100062f10
