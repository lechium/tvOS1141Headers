...
- (void).cxx_destruct;	// IMP=0x0000000100064200
- (id)preferredFocusEnvironments;	// IMP=0x00000001000640d0
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000100063f38
- (void)confirmationButton:(id)arg1 tappedWithHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100063e6c
- (void)layoutSubviews;	// IMP=0x0000000100063ca4
- (double)_confirmationButtonYOriginInBounds:(struct CGRect)arg1;	// IMP=0x0000000100063bac
- (void)enableReadAgainButton;	// IMP=0x0000000100063a60
- (id)initWithFrame:(struct CGRect)arg1 confirmationButtons:(id)arg2 delegate:(id)arg3;	// IMP=0x0000000100063624
