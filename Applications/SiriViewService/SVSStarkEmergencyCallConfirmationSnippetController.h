...
- (void).cxx_destruct;	// IMP=0x00000001000659fc
- (void)_setCountdownString;	// IMP=0x0000000100065844
- (void)_updateCountdown:(id)arg1;	// IMP=0x00000001000655d0
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0000000100065494
- (id)initWithAceObject:(id)arg1 conversationItemIdentifier:(id)arg2 interactionStyle:(long long)arg3;	// IMP=0x0000000100065340
