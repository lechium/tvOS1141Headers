...
- (void).cxx_destruct;	// IMP=0x000000010003989c
- (double)_confirmationButtonYOriginInBounds:(struct CGRect)arg1;	// IMP=0x0000000100039808
- (void)layoutSubviews;	// IMP=0x0000000100039688
- (id)_createLabelWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000395ac
- (id)initWithFrame:(struct CGRect)arg1 confirmationButtons:(id)arg2 delegate:(id)arg3;	// IMP=0x00000001000393e4
