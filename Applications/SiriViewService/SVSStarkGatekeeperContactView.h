...
+ (id)associatedDataStore;	// IMP=0x00000001000669fc
...
- (void)layoutSubviews;	// IMP=0x0000000100066bd0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100066a7c
- (void)_configureWithDisplayName:(id)arg1 contactPhoto:(id)arg2 contactPhotoURL:(id)arg3 appImage:(id)arg4 nameComponents:(id)arg5;	// IMP=0x000000010006621c
- (id)initWithMessageIntent:(id)arg1;	// IMP=0x0000000100066024
- (id)initWithSms:(id)arg1;	// IMP=0x0000000100065f00
