...
+ (id)sharedApplication;	// IMP=0x0000000100064618
@property(nonatomic) __weak id <SVSApplicationDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void).cxx_destruct;	// IMP=0x00000001000646fc
- (void)setFrontMostAppOrientation:(long long)arg1;	// IMP=0x00000001000646b8
- (long long)launchOrientation;	// IMP=0x00000001000646a8
