...
- (void)_updatePlaybackActive;	// IMP=0x000000010001351c
- (void)_updateCloudConnectivityState;	// IMP=0x0000000100013320
- (void)_reenableAirPlaySpeakerIfNecessary;	// IMP=0x0000000100012f5c
- (void)_disableAirPlaySpeakerIfNecessary;	// IMP=0x0000000100012bf8
- (void)applicationWillTerminate:(id)arg1;	// IMP=0x0000000100012a54
- (void)dealloc;	// IMP=0x00000001000129dc
- (_Bool)application:(id)arg1 didFinishLaunchingWithOptions:(id)arg2;	// IMP=0x00000001000126b4
