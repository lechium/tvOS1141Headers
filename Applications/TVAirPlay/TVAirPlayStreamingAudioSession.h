...
- (void).cxx_destruct;	// IMP=0x0000000100010374
- (void)userStop;	// IMP=0x00000001000102f0
- (_Bool)setProperty:(id)arg1 qualifier:(id)arg2 value:(id)arg3 error:(id *)arg4;	// IMP=0x000000010001019c
- (_Bool)performAction:(id)arg1 withOptions:(id)arg2 outInfo:(id *)arg3 error:(id *)arg4;	// IMP=0x0000000100010194
- (id)getProperty:(id)arg1 qualifier:(id)arg2 error:(id *)arg3;	// IMP=0x000000010001018c
- (_Bool)stopWithOptions:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000100f0
- (void)startWithOptions:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010000ff1c
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000010000fe04
- (id)init;	// IMP=0x000000010000f940
