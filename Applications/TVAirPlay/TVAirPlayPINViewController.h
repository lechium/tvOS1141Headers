...
- (void).cxx_destruct;	// IMP=0x0000000100013eec
- (void)_menuPressed;	// IMP=0x0000000100013e30
- (void)setTitle:(id)arg1;	// IMP=0x0000000100013c38
- (void)viewDidLoad;	// IMP=0x00000001000136d4
