...
+ (id)_remoteViewControllerInterface;	// IMP=0x0000000100016e04
+ (id)_exportedInterface;	// IMP=0x0000000100016ce8
...
- (void).cxx_destruct;	// IMP=0x0000000100017530
- (void)_transitionFromViewController:(id)arg1 toViewController:(id)arg2;	// IMP=0x0000000100016e20
- (void)viewServiceEndPresentationWithOptions:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000169cc
- (void)viewServiceBeginPresentationWithOptions:(id)arg1;	// IMP=0x0000000100016880
- (void)dismiss;	// IMP=0x0000000100016774
- (id)preferredFocusEnvironments;	// IMP=0x0000000100015e60
