...
- (void)setSelected:(_Bool)arg1;	// IMP=0x0000000100014548
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000001000144bc
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100014310
- (_Bool)canBecomeFocused;	// IMP=0x0000000100014308
- (void)updateOverlay;	// IMP=0x0000000100014284
- (void)updateImage;	// IMP=0x0000000100013f0c
- (void)updateRank;	// IMP=0x0000000100013d10
@property(readonly, nonatomic) UIView *popoverSourceView;
- (void)dealloc;	// IMP=0x0000000100013a20
- (void)awakeFromNib;	// IMP=0x0000000100013948
