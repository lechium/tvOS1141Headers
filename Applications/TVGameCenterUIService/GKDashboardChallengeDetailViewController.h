...
- (void)decline:(id)arg1;	// IMP=0x000000010001a288
- (void)challengeOK:(id)arg1;	// IMP=0x000000010001a274
- (void)play:(id)arg1;	// IMP=0x000000010001a21c
- (void)updateLeaderboardImage;	// IMP=0x000000010001a1cc
- (void)configureForChallenge;	// IMP=0x0000000100019cc4
- (id)preferredFocusEnvironments;	// IMP=0x0000000100019c40
- (void)viewDidLoad;	// IMP=0x0000000100019b38
- (void)dealloc;	// IMP=0x0000000100019ae0
- (id)initWithChallenge:(id)arg1;	// IMP=0x0000000100019a1c
