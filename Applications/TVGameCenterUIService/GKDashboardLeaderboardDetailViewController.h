...
- (void)report:(id)arg1;	// IMP=0x0000000100017ee8
- (void)share:(id)arg1;	// IMP=0x0000000100017dd8
- (void)challenge:(id)arg1;	// IMP=0x0000000100017bf4
- (void)configureForScore;	// IMP=0x0000000100017694
- (id)preferredFocusEnvironments;	// IMP=0x0000000100017610
- (void)viewDidLoad;	// IMP=0x00000001000174c4
- (void)dealloc;	// IMP=0x0000000100017454
- (id)initWithScore:(id)arg1 leaderboard:(id)arg2;	// IMP=0x0000000100017378
