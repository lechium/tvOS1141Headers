...
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x000000010001d078
- (id)collectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2;	// IMP=0x000000010001cf9c
- (_Bool)isShowMoreIndexPath:(id)arg1;	// IMP=0x000000010001cf18
- (long long)collectionView:(id)arg1 numberOfItemsInSection:(long long)arg2;	// IMP=0x000000010001ced0
- (void)loadDataWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010001cbf0
- (void)setupCollectionView:(id)arg1;	// IMP=0x000000010001caa8
...
- (id)initWithGameRecord:(id)arg1;	// IMP=0x000000010001c8dc
