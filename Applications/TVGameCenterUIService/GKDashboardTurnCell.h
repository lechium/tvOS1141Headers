...
+ (struct CGSize)defaultSizeForTurnDetail;	// IMP=0x00000001000200d0
...
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100020844
- (void)setOnDarkBackground:(_Bool)arg1;	// IMP=0x0000000100020768
- (void)configureForParticipant:(id)arg1 inMatch:(id)arg2;	// IMP=0x00000001000203f8
- (void)configureForMatch:(id)arg1;	// IMP=0x000000010002011c
- (_Bool)wantsLocalPlayerAction:(id)arg1;	// IMP=0x00000001000200e4
- (void)dealloc;	// IMP=0x0000000100020060
- (void)awakeFromNib;	// IMP=0x000000010001ff1c
