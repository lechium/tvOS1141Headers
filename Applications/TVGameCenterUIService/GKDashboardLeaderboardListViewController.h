...
- (id)collectionView:(id)arg1 viewForSupplementaryElementOfKind:(id)arg2 atIndexPath:(id)arg3;	// IMP=0x000000010000a790
- (void)viewDidLoad;	// IMP=0x000000010000a5fc
- (void)dealloc;	// IMP=0x000000010000a5a4
- (id)initWithGameRecord:(id)arg1 leaderboardSet:(id)arg2;	// IMP=0x000000010000a49c
