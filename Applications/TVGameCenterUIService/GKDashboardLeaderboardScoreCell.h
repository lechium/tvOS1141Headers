...
+ (id)highRankNib;	// IMP=0x000000010001ee14
+ (id)lowRankNib;	// IMP=0x000000010001ede8
+ (struct CGSize)defaultSize;	// IMP=0x000000010001edd4
...
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010001f26c
@property(nonatomic) _Bool linesVisible; // @dynamic linesVisible;
- (void)setupForScore:(id)arg1;	// IMP=0x000000010001f0b4
@property(readonly, nonatomic) UIView *popoverSourceView;
- (void)dealloc;	// IMP=0x000000010001efb8
- (void)awakeFromNib;	// IMP=0x000000010001ee40
