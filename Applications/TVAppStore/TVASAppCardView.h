...
+ (id)appCardViewFromElement:(id)arg1 existingView:(id)arg2;	// IMP=0x0000000100005dd4
...
- (struct UIEdgeInsets)selectionMarginsForSize:(struct CGSize)arg1;	// IMP=0x00000001000081d8
- (void)layoutSubviews;	// IMP=0x0000000100007a00
- (void)applyFocusedLayout;	// IMP=0x000000010000769c
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000100006dcc
- (unsigned long long)_primaryStateForState:(unsigned long long)arg1;	// IMP=0x0000000100006da0
@property(nonatomic, getter=isSelected) _Bool selected;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010000672c
