...
- (void).cxx_destruct;	// IMP=0x0000000100012bd4
- (Class)collectionViewCellClassForElement:(id)arg1;	// IMP=0x0000000100012b0c
- (id)viewForElement:(id)arg1 existingView:(id)arg2;	// IMP=0x000000010001291c
- (void)appController:(id)arg1 evaluateAppJavaScriptInContext:(id)arg2;	// IMP=0x000000010001276c
- (id)init;	// IMP=0x00000001000124fc
