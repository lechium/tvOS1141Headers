...
- (void).cxx_destruct;	// IMP=0x0000000100016528
- (void)_applicationDidBecomeActiveNotification:(id)arg1;	// IMP=0x0000000100016390
- (void)_applicationWillResignActiveNotification:(id)arg1;	// IMP=0x0000000100016338
- (void)setMarqueeRunning:(_Bool)arg1;	// IMP=0x000000010001632c
- (void)setMarqueeEnabled:(_Bool)arg1;	// IMP=0x0000000100016328
- (void)_startMarqueeIfNeeded;	// IMP=0x0000000100014c40
- (_Bool)_shouldCycle;	// IMP=0x0000000100014bf0
- (void)_clearLabelTextContents;	// IMP=0x0000000100014a30
- (void)_prepareNextMarquee;	// IMP=0x0000000100014a18
- (void)_nextAttributedString;	// IMP=0x00000001000144c0
- (id)_imageForText:(_Bool)arg1;	// IMP=0x00000001000142c8
- (void)drawTextInRect:(struct CGRect)arg1;	// IMP=0x00000001000140c8
- (void)stopAndResetScrollWithDuration:(double)arg1;	// IMP=0x0000000100013954
- (void)stopAnimatingWithoutResetWithDuration:(double)arg1;	// IMP=0x00000001000138c4
- (void)stopAnimating;	// IMP=0x0000000100013808
- (void)setNeedsDisplay;	// IMP=0x0000000100013470
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000100013398
- (void)_clearAttributedStrings;	// IMP=0x0000000100013204
- (void)setAttributedText:(id)arg1;	// IMP=0x0000000100013144
- (void)setText:(id)arg1;	// IMP=0x00000001000130b8
- (void)dealloc;	// IMP=0x0000000100013040
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100012d8c
