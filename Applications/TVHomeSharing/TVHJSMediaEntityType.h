...
- (void).cxx_destruct;	// IMP=0x0000000100028614
...
- (id)initWithMediaEntityType:(id)arg1 appContext:(id)arg2;	// IMP=0x00000001000281f8
- (id)initWithAppContext:(id)arg1;	// IMP=0x0000000100028170
- (id)init;	// IMP=0x00000001000280e8
