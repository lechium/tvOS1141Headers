...
- (void).cxx_destruct;	// IMP=0x000000010002e540
- (void)_completeWithFetchResult:(id)arg1 error:(id)arg2;	// IMP=0x000000010002e224
- (void)_startFetchingMediaEntities;	// IMP=0x000000010002e154
- (id)_fetchRequest;	// IMP=0x000000010002dee4
- (void)_stopObservingMediaServer:(id)arg1;	// IMP=0x000000010002de54
- (void)_startObservingMediaServer:(id)arg1;	// IMP=0x000000010002ddbc
- (id)_stateMachineName;	// IMP=0x000000010002dd20
- (void)_registerStateMachineHandlers;	// IMP=0x000000010002d38c
- (void)_setupStateMachine;	// IMP=0x000000010002d2f4
- (void)_handleMediaServerConnectionStateDidChangeNotification:(id)arg1;	// IMP=0x000000010002d188
- (void)controller:(id)arg1 fetchRequest:(id)arg2 didFailWithError:(id)arg3;	// IMP=0x000000010002d090
- (void)controller:(id)arg1 fetchRequest:(id)arg2 didCompleteWithResult:(id)arg3;	// IMP=0x000000010002cf9c
- (void)fetchMediaEntitiesWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000010002cd70
- (void)dealloc;	// IMP=0x000000010002cd18
- (id)initWithMediaCategoryType:(unsigned long long)arg1 mediaServerIdentifier:(id)arg2 mediaCollectionIdentifier:(id)arg3;	// IMP=0x000000010002cbd0
