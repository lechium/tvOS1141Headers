...
+ (id)mediaCategoryTypesFetchControllerWithMediaServer:(id)arg1;	// IMP=0x000000010002734c
...
- (void).cxx_destruct;	// IMP=0x0000000100027c3c
- (void)controller:(id)arg1 fetchDidFailWithError:(id)arg2;	// IMP=0x00000001000279c0
- (void)controller:(id)arg1 fetchDidCompleteWithResult:(id)arg2;	// IMP=0x00000001000276c4
- (void)resume;	// IMP=0x0000000100027684
- (void)pause;	// IMP=0x0000000100027644
- (void)stop;	// IMP=0x00000001000275ec
- (void)start;	// IMP=0x0000000100027568
@property(copy, nonatomic) NSString *identifier;
@property(copy, nonatomic) NSString *logNameSuffix;
- (id)initWithMediaServer:(id)arg1 appContext:(id)arg2;	// IMP=0x0000000100027260
- (id)initWithAppContext:(id)arg1;	// IMP=0x00000001000271d8
