...
- (void).cxx_destruct;	// IMP=0x000000010000d908
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000010000d80c
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000010000d6a0
- (id)initWithPlayer:(id)arg1;	// IMP=0x000000010000d618
