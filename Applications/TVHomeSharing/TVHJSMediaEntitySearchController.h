...
+ (id)create:(id)arg1;	// IMP=0x0000000100025180
...
- (void).cxx_destruct;	// IMP=0x0000000100027058
- (void)_updateJSMediaQueryResult:(id)arg1 withJSMediaEntities:(id)arg2 andChanges:(id)arg3;	// IMP=0x0000000100026ce4
- (void)_updateMutableArraysWithResult:(id)arg1;	// IMP=0x0000000100026734
- (void)_updateMutableArray:(id)arg1 withResult:(id)arg2;	// IMP=0x00000001000264a4
- (void)controller:(id)arg1 searchRequest:(id)arg2 didFailWithError:(id)arg3;	// IMP=0x000000010002618c
- (void)controller:(id)arg1 searchRequest:(id)arg2 didCompleteWithResult:(id)arg3;	// IMP=0x0000000100025434
- (void)resume;	// IMP=0x00000001000253f4
- (void)pause;	// IMP=0x00000001000253b4
@property(copy, nonatomic) NSString *searchText;
- (id)initWithMediaServer:(id)arg1 appContext:(id)arg2;	// IMP=0x0000000100024d94
- (id)initWithAppContext:(id)arg1;	// IMP=0x0000000100024d0c
