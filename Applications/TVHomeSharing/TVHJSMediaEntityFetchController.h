...
+ (id)_jsSortHeadersFromSortHeaders:(id)arg1 appContext:(id)arg2;	// IMP=0x0000000100014118
+ (id)_jsMediaEntitiesFromMediaEntities:(id)arg1 indexes:(id)arg2 appContext:(id)arg3;	// IMP=0x0000000100014028
+ (id)create:(id)arg1:(id)arg2;	// IMP=0x0000000100011bc4
...
- (void)_updateJSMediaQueryResult:(id)arg1 withJSObjects:(id)arg2 andChanges:(id)arg3 sortHeaders:(id)arg4;	// IMP=0x0000000100013f10
- (id)_groupsValueTransformerWithKeyPath:(id)arg1;	// IMP=0x0000000100013d84
- (void)_updateGroupingWithResult:(id)arg1 forKeyPath:(id)arg2;	// IMP=0x000000010001372c
- (void)_updateGroupingsWithResult:(id)arg1;	// IMP=0x00000001000135b0
- (void)_applyChanges:(id)arg1 fromSourceMediaEntities:(id)arg2 toDestinationMediaEntities:(id)arg3;	// IMP=0x00000001000133ec
- (void)_updateMediaEntitiesMutableArray:(id)arg1 withResult:(id)arg2;	// IMP=0x000000010001328c
- (void)_updateJSArraysWithResult:(id)arg1;	// IMP=0x0000000100013088
- (void)controller:(id)arg1 fetchRequest:(id)arg2 didFailWithError:(id)arg3;	// IMP=0x0000000100012d0c
- (void)controller:(id)arg1 fetchRequest:(id)arg2 didCompleteWithResult:(id)arg3;	// IMP=0x00000001000124a0
- (void)simulateContentsChangeWithFetchFromServer:(_Bool)arg1;	// IMP=0x00000001000123f4
- (void)resume;	// IMP=0x00000001000123b4
- (void)pause;	// IMP=0x0000000100012374
- (void)stop;	// IMP=0x0000000100012288
- (void)start;	// IMP=0x0000000100012204
...
- (id)initWithMediaServer:(id)arg1 fetchRequest:(id)arg2 appContext:(id)arg3;	// IMP=0x00000001000119a4
- (id)initWithAppContext:(id)arg1;	// IMP=0x000000010001191c
