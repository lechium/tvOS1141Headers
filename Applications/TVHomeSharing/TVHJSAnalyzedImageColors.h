...
- (void).cxx_destruct;	// IMP=0x0000000100037088
@property(readonly, nonatomic) _Bool isBackgroundLight;
- (id)initWithAnalyzedImageColors:(id)arg1 appContext:(id)arg2;	// IMP=0x0000000100036f90
- (id)initWithAppContext:(id)arg1;	// IMP=0x0000000100036f08
