...
- (id)imageResourceNameWithSize:(id)arg1;	// IMP=0x00000001000293a8
...
- (id)initWithMediaEntity:(id)arg1 appContext:(id)arg2;	// IMP=0x00000001000287a0
- (id)initWithAppContext:(id)arg1;	// IMP=0x0000000100028718
- (id)init;	// IMP=0x0000000100028690
