...
- (void).cxx_destruct;	// IMP=0x000000010002b908
- (void)layoutSubviews;	// IMP=0x000000010002b590
- (void)_updateColors;	// IMP=0x000000010002b3c0
- (void)updateWithViewElement:(id)arg1;	// IMP=0x000000010002ac88
