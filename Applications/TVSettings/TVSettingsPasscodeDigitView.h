...
- (void).cxx_destruct;	// IMP=0x00000001000afc38
- (id)hiddenDigitImage;	// IMP=0x00000001000af7a4
- (id)arrowImage:(_Bool)arg1;	// IMP=0x00000001000af594
- (void)downGesture:(id)arg1;	// IMP=0x00000001000af44c
- (void)upGesture:(id)arg1;	// IMP=0x00000001000af318
@property(copy, nonatomic) NSString *text;
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001000af074
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000001000aef14
- (_Bool)canBecomeFocused;	// IMP=0x00000001000aef0c
- (void)layoutSubviews;	// IMP=0x00000001000aec6c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000ae518
