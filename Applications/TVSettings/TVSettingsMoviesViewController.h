...
- (void).cxx_destruct;	// IMP=0x000000010008d100
- (void)_videoResolutionSelected:(id)arg1;	// IMP=0x000000010008d064
- (id)previewForItemAtIndexPath:(id)arg1;	// IMP=0x000000010008cd84
- (id)loadSettingGroups;	// IMP=0x000000010008b580
