...
- (void).cxx_destruct;	// IMP=0x00000001000922c8
- (id)_imageForAction:(int)arg1;	// IMP=0x0000000100091cfc
- (void)_learnNextAction:(id)arg1;	// IMP=0x0000000100091c5c
- (void)_learnPreviousAction:(id)arg1;	// IMP=0x0000000100091bbc
- (void)_updateProgressViewWithProgress:(double)arg1 animated:(_Bool)arg2;	// IMP=0x0000000100091b24
- (void)_hideProgressView;	// IMP=0x0000000100091a9c
- (void)irLearningManager:(id)arg1 didFinishLearningAction:(int)arg2;	// IMP=0x0000000100091578
- (void)irLearningManager:(id)arg1 didCompleteLearningAction:(int)arg2 withResult:(_Bool)arg3 error:(id)arg4;	// IMP=0x0000000100090fb8
- (void)irLearningManager:(id)arg1 didLearnAction:(int)arg2 withProgress:(double)arg3;	// IMP=0x0000000100090e54
- (void)irLearningManager:(id)arg1 willStartLearningAction:(int)arg2;	// IMP=0x0000000100090ae0
- (void)irLearningManagerDidCancel:(id)arg1;	// IMP=0x0000000100090adc
- (void)irLearningManager:(id)arg1 didSaveLearnedActions:(id)arg2 forDeviceWithUUID:(id)arg3;	// IMP=0x000000010009078c
- (void)irLearningManager:(id)arg1 didFailToStartLearningWithError:(id)arg2;	// IMP=0x0000000100090578
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100090358
- (id)preferredFocusEnvironments;	// IMP=0x00000001000902b4
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0000000100090138
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000010008ff40
- (void)viewDidLoad;	// IMP=0x000000010008e9b4
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000010008e8bc
