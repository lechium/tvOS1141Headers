...
+ (id)sharedInstance;	// IMP=0x0000000100016190
...
- (void).cxx_destruct;	// IMP=0x00000001000169b8
@property(readonly, nonatomic) NSArray *appearanceOptions;
- (void)_updateSystemAppearance;	// IMP=0x0000000100016494
- (void)invalidateSystemAppearance;	// IMP=0x0000000100016480
@property(nonatomic) long long systemAppearance;
- (id)init;	// IMP=0x0000000100016210
