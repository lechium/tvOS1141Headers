...
+ (id)sharedTransitionTester;	// IMP=0x0000000100049720
...
- (void).cxx_destruct;	// IMP=0x0000000100049dc0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100049a14
- (void)startPopTransition;	// IMP=0x00000001000499ac
- (void)startPushTransition;	// IMP=0x0000000100049868
- (void)runTest;	// IMP=0x000000010004976c
