...
- (id)description;	// IMP=0x0000000100034d78
- (id)init;	// IMP=0x0000000100034d60
- (id)initWithChangeKind:(unsigned long long)arg1 sourceIndexes:(id)arg2 destinationIndexes:(id)arg3;	// IMP=0x0000000100034c80
