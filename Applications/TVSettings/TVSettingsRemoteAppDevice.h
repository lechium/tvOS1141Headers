...
- (void).cxx_destruct;	// IMP=0x000000010007d500
- (void)pairWithPasscode:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010007d3d0
- (void)unpairWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010007d348
- (unsigned long long)hash;	// IMP=0x000000010007d2d4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010007d078
- (id)initWithEndpoint:(id)arg1;	// IMP=0x000000010007cfb4
- (id)initWithDeviceRef:(void *)arg1;	// IMP=0x000000010007cf08
