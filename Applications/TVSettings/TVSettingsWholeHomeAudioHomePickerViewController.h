...
- (void).cxx_destruct;	// IMP=0x0000000100007198
- (void)_didSelectHomeItem:(id)arg1;	// IMP=0x000000010000701c
- (id)loadSettingGroups;	// IMP=0x0000000100006d78
- (id)initWithStyle:(long long)arg1;	// IMP=0x0000000100006cb8
