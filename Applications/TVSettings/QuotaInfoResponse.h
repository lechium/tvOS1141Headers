...
- (void).cxx_destruct;	// IMP=0x00000001000c9990
- (_Bool)hasPurchasedMoreStorage;	// IMP=0x00000001000c991c
- (id)storageFooter:(_Bool)arg1;	// IMP=0x00000001000c9914
...
- (id)initWithHTTPResponse:(id)arg1 data:(id)arg2;	// IMP=0x00000001000c9190
