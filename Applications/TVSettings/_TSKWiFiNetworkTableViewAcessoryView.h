...
- (void).cxx_destruct;	// IMP=0x0000000100048064
- (void)setTintColor:(id)arg1;	// IMP=0x0000000100047fa4
- (void)layoutSubviews;	// IMP=0x0000000100047bf8
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100047b2c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100047864
