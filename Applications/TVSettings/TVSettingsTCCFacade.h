...
- (void)_updateTCCInfo;	// IMP=0x000000010008882c
- (void)applicationDidBecomeActive:(id)arg1;	// IMP=0x0000000100088820
- (_Bool)setAllowAccess:(_Bool)arg1 forInfo:(id)arg2;	// IMP=0x00000001000887d0
- (id)infoForIdentifier:(id)arg1;	// IMP=0x00000001000887b8
- (void)dealloc;	// IMP=0x00000001000886fc
- (id)initWithServiceName:(id)arg1;	// IMP=0x0000000100088574
- (id)init;	// IMP=0x000000010008855c
