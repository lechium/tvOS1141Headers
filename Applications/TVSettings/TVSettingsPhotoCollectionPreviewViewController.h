...
- (void).cxx_destruct;	// IMP=0x00000001000a611c
- (void)_updateViewWithImageProxies:(id)arg1 inCollection:(id)arg2;	// IMP=0x00000001000a6070
- (void)viewDidLayoutSubviews;	// IMP=0x00000001000a5a4c
- (void)loadView;	// IMP=0x00000001000a597c
