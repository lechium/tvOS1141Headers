...
+ (id)_keyValueDictionaryForURL:(id)arg1;	// IMP=0x00000001000c0f48
+ (id)configWithPrefsURL:(id)arg1;	// IMP=0x00000001000c0744
+ (id)configWithAppSettingsURL:(id)arg1;	// IMP=0x00000001000c0610
+ (id)configWithSettingsURL:(id)arg1;	// IMP=0x00000001000c0560
...
- (void).cxx_destruct;	// IMP=0x00000001000c123c
