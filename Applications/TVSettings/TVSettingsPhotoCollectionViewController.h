...
- (void).cxx_destruct;	// IMP=0x000000010006f838
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x000000010006f720
- (id)collectionView:(id)arg1 viewForSupplementaryElementOfKind:(id)arg2 atIndexPath:(id)arg3;	// IMP=0x000000010006f540
- (id)collectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2;	// IMP=0x000000010006f384
- (long long)collectionView:(id)arg1 numberOfItemsInSection:(long long)arg2;	// IMP=0x000000010006f36c
- (id)preferredFocusEnvironments;	// IMP=0x000000010006ef58
- (void)loadView;	// IMP=0x000000010006ecbc
- (void)dealloc;	// IMP=0x000000010006ec44
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000010006eb74
