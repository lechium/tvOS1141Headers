...
- (void).cxx_destruct;	// IMP=0x000000010002d6cc
- (void)_stopAnimations;	// IMP=0x000000010002d4f8
- (void)_startAnimations;	// IMP=0x000000010002cb74
- (void)_addImageToAnimationContainer:(id)arg1;	// IMP=0x000000010002c8a4
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000010002c894
- (void)layoutSubviews;	// IMP=0x000000010002c094
- (void)didMoveToWindow;	// IMP=0x000000010002bfd8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010002befc
