...
- (void).cxx_destruct;	// IMP=0x0000000100048e14
- (void)editingController:(id)arg1 didCancelForSettingItem:(id)arg2;	// IMP=0x0000000100048d2c
- (void)editingController:(id)arg1 didProvideValue:(id)arg2 forSettingItem:(id)arg3;	// IMP=0x0000000100048a98
- (void)viewDidLoad;	// IMP=0x00000001000487fc
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000100048774
