...
- (void).cxx_destruct;	// IMP=0x00000001000156e8
- (void)_crossfadeToImage:(id)arg1;	// IMP=0x00000001000153b8
- (void)_loadNextImage:(id)arg1;	// IMP=0x0000000100015310
- (void)_startTimer;	// IMP=0x0000000100015258
- (struct CGSize)_maximumImageSize;	// IMP=0x0000000100015210
- (void)layoutSubviews;	// IMP=0x0000000100014bd4
- (void)didMoveToSuperview;	// IMP=0x0000000100014b6c
- (void)dealloc;	// IMP=0x0000000100014b14
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100014a10
