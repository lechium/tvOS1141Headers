...
- (void).cxx_destruct;	// IMP=0x0000000100080cdc
- (void)_fetchAppUsageInfo;	// IMP=0x00000001000807f4
- (void)uninstallAppWithProxy:(id)arg1;	// IMP=0x0000000100080610
- (void)dealloc;	// IMP=0x0000000100080534
- (id)init;	// IMP=0x00000001000803cc
