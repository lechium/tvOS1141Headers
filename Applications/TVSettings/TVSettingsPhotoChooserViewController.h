...
- (void).cxx_destruct;	// IMP=0x0000000100016158
- (void)_launchAppForSettingItem:(id)arg1;	// IMP=0x0000000100015f6c
- (void)_didSelectSettingItem:(id)arg1;	// IMP=0x0000000100015ebc
- (id)_photoCollectionGroups;	// IMP=0x0000000100015e08
- (id)_localizedTitleForPhotoCollectionGroup:(id)arg1;	// IMP=0x0000000100015df8
- (void)controller:(id)arg1 didSelectAsset:(id)arg2 inCollection:(id)arg3;	// IMP=0x0000000100015cf4
- (id)loadSettingGroups;	// IMP=0x00000001000157c0
- (id)title;	// IMP=0x0000000100015750
