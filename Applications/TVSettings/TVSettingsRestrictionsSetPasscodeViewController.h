...
- (void).cxx_destruct;	// IMP=0x00000001000c80d4
- (void)digitEntryViewControllerDidFinish:(id)arg1;	// IMP=0x00000001000c7960
- (void)digitEntryViewControllerDidCancel:(id)arg1;	// IMP=0x00000001000c78ec
- (void)viewWillLayoutSubviews;	// IMP=0x00000001000c77f4
- (void)viewDidLoad;	// IMP=0x00000001000c7720
- (id)preferredFocusEnvironments;	// IMP=0x00000001000c76cc
- (id)initWithTitle:(id)arg1 prompt:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000c7408
