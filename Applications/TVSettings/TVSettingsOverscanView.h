...
- (void).cxx_destruct;	// IMP=0x000000010008843c
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000001000880c0
- (void)layoutSubviews;	// IMP=0x0000000100087d4c
@property(copy, nonatomic) NSString *instructionText;
@property(copy, nonatomic) NSString *titleText;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100087758
