...
- (void).cxx_destruct;	// IMP=0x00000001000b45b4
- (void)_updateImageViewWithPlaceholderImageIfNeeded;	// IMP=0x00000001000b4450
- (void)_setImage:(id)arg1;	// IMP=0x00000001000b42dc
- (id)_imageView;	// IMP=0x00000001000b4144
- (void)_loadImage;	// IMP=0x00000001000b3a38
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000001000b38c4
@property(nonatomic) double cornerRadius;
- (void)setImageProxy:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000b34d4
@property(retain, nonatomic) UIImage *image;
- (void)willMoveToWindow:(id)arg1;	// IMP=0x00000001000b33c8
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000b3320
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000001000b32ac
- (void)setContentMode:(long long)arg1;	// IMP=0x00000001000b3288
- (void)layoutSubviews;	// IMP=0x00000001000b321c
- (long long)contentMode;	// IMP=0x00000001000b3204
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000001000b31ec
- (void)dealloc;	// IMP=0x00000001000b3180
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000b3094
