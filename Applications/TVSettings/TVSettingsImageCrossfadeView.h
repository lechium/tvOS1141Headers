...
- (void).cxx_destruct;	// IMP=0x0000000100035a30
- (void)_crossfadeToImage:(id)arg1;	// IMP=0x0000000100035728
- (void)_loadNextImage:(id)arg1;	// IMP=0x0000000100035680
- (void)_startTimer;	// IMP=0x00000001000355c8
- (void)layoutSubviews;	// IMP=0x0000000100035110
- (void)didMoveToSuperview;	// IMP=0x00000001000350a8
- (void)dealloc;	// IMP=0x0000000100035050
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100034f48
