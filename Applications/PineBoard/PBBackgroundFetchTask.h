...
- (void)finishWithResult:(unsigned long long)arg1;	// IMP=0x00000001000da2b4
- (id)initForApplication:(id)arg1 sequenceNumber:(unsigned int)arg2;	// IMP=0x00000001000d9e54
