...
+ (id)sharedInstance;	// IMP=0x00000001000d622c
...
- (void).cxx_destruct;	// IMP=0x00000001000d76fc
- (void)_updateAppButtonAccess;	// IMP=0x00000001000d74a4
- (void)_updateApplicationState:(id)arg1;	// IMP=0x00000001000d6a08
- (void)setExclusivePlayPauseButtonAccessEnabled:(_Bool)arg1 forApp:(id)arg2;	// IMP=0x00000001000d683c
- (void)setVolumeButtonAccessEnabled:(_Bool)arg1 forApp:(id)arg2;	// IMP=0x00000001000d6670
- (id)init;	// IMP=0x00000001000d62e4
