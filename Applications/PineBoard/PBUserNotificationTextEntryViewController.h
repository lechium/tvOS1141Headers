...
- (void).cxx_destruct;	// IMP=0x000000010001805c
- (id)_messageStringAttributes;	// IMP=0x0000000100017dac
- (id)_titleStringAttributes;	// IMP=0x0000000100017c00
- (void)_handleHomeButton;	// IMP=0x00000001000179f0
- (void)_menuButtonPressed:(id)arg1;	// IMP=0x00000001000178dc
- (void)textEntryControllerDidFinish:(id)arg1;	// IMP=0x000000010001781c
- (void)buttonView:(id)arg1 didSelectButton:(id)arg2 atIndex:(long long)arg3;	// IMP=0x000000010001771c
- (id)textField;	// IMP=0x0000000100017680
- (void)_showChildViewController:(id)arg1;	// IMP=0x00000001000174fc
- (id)_buttonsForTextField:(long long)arg1 defaultButtonIndex:(long long *)arg2;	// IMP=0x00000001000170f0
- (void)_showTextEntryViewControllerForTextField:(long long)arg1;	// IMP=0x0000000100016a98
- (void)_configureStateMachine;	// IMP=0x0000000100016118
- (id)presentationControllerForPresentedViewController:(id)arg1 presentingViewController:(id)arg2 sourceViewController:(id)arg3;	// IMP=0x000000010001609c
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x0000000100016068
- (id)animationControllerForPresentedController:(id)arg1 presentingController:(id)arg2 sourceController:(id)arg3;	// IMP=0x0000000100016034
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100015f94
- (void)loadView;	// IMP=0x0000000100015dcc
- (id)init;	// IMP=0x0000000100015c58
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000100015bac
