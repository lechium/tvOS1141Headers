...
- (void).cxx_destruct;	// IMP=0x0000000100098dac
- (struct CGPoint)_preferredContentOffsetForIndexPath:(id)arg1;	// IMP=0x0000000100098adc
- (void)_prepareToLaunchItemImmediately:(id)arg1;	// IMP=0x000000010009888c
- (_Bool)_servicePendingUpdatesWithAnimation:(_Bool)arg1;	// IMP=0x000000010009851c
- (void)_handleCollectionViewUpdatesWithAnimation:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100097bb0
- (void)_finishKillSwipeWithVelocity:(double)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100097780
- (void)_cancelKillSwipeWithVelocity:(double)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100097450
- (void)_updateKillSwipeWithOffset:(double)arg1;	// IMP=0x0000000100097378
- (void)_setKillGestureRecognizersEnabled:(_Bool)arg1;	// IMP=0x0000000100097320
- (void)_launchItem:(id)arg1 shouldAnimateLayoutSwitch:(_Bool)arg2;	// IMP=0x0000000100096cc4
- (_Bool)_shouldScrollToItem:(id)arg1 scrollIfNeeded:(_Bool)arg2 forced:(_Bool)arg3;	// IMP=0x0000000100096b04
- (_Bool)_activateItem:(id)arg1;	// IMP=0x0000000100096944
- (void)_activatePendingLaunchItem;	// IMP=0x0000000100096758
- (void)_showAppSwitcher;	// IMP=0x0000000100095ff8
- (void)_initializeStateMachine;	// IMP=0x00000001000932e8
- (void)manager:(id)arg1 didReceiveLaunchRequestForItem:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000931e4
- (void)managerDidEnqueuePendingUpdates:(id)arg1;	// IMP=0x00000001000930f4
- (void)panGestureRecognizerMoved:(id)arg1;	// IMP=0x0000000100092834
- (void)upDoubleTapped:(id)arg1;	// IMP=0x00000001000925cc
- (void)scrollViewDidEndScrollingAnimation:(id)arg1;	// IMP=0x00000001000924e0
- (void)scrollViewDidEndDecelerating:(id)arg1;	// IMP=0x00000001000924c0
- (void)scrollViewWillBeginDecelerating:(id)arg1;	// IMP=0x00000001000924a0
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x000000010009237c
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000100092148
- (_Bool)collectionView:(id)arg1 shouldUpdateFocusInContext:(id)arg2;	// IMP=0x0000000100092060
- (struct CGPoint)collectionView:(id)arg1 targetContentOffsetForProposedContentOffset:(struct CGPoint)arg2;	// IMP=0x0000000100092048
- (id)indexPathForPreferredFocusedViewInCollectionView:(id)arg1;	// IMP=0x0000000100092038
- (id)collectionView:(id)arg1 cellForItemAtIndexPath:(id)arg2;	// IMP=0x0000000100091ef8
- (long long)collectionView:(id)arg1 numberOfItemsInSection:(long long)arg2;	// IMP=0x0000000100091ea0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000100091d24
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100091c14
- (id)preferredFocusEnvironments;	// IMP=0x0000000100091b70
- (void)viewDidLayoutSubviews;	// IMP=0x0000000100091a1c
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00000001000919a0
- (void)viewDidLoad;	// IMP=0x0000000100091170
- (id)initWithManager:(id)arg1;	// IMP=0x00000001000910c0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000001000910a8
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100091090
