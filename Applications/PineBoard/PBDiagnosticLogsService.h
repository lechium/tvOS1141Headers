...
- (void).cxx_destruct;	// IMP=0x0000000100007ee4
- (void)incrementScalarKey:(id)arg1;	// IMP=0x0000000100007df0
- (void)diagnosticLogPathsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100007cd0
- (void)invalidate;	// IMP=0x0000000100007ccc
- (id)initWithRemoteConnection:(id)arg1;	// IMP=0x0000000100007c4c
- (id)init;	// IMP=0x0000000100007c34
