...
- (void).cxx_destruct;	// IMP=0x00000001000e5568
- (void)_didSelectButtonAtIndex:(unsigned long long)arg1;	// IMP=0x00000001000e54cc
- (void)updateWithNotification:(id)arg1;	// IMP=0x00000001000e4b10
- (void)_handleHomeButton;	// IMP=0x00000001000e4824
- (void)_handleMenuButton;	// IMP=0x00000001000e4728
- (void)viewDidLoad;	// IMP=0x00000001000e44e0
- (id)init;	// IMP=0x00000001000e4484
