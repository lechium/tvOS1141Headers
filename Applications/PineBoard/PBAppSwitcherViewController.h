...
- (void).cxx_destruct;	// IMP=0x00000001000d0328
- (void)exitToCurrentApplication;	// IMP=0x00000001000d0214
- (void)handleTransitionWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000cff28
- (id)preferredFocusEnvironments;	// IMP=0x00000001000cff10
- (void)viewDidLoad;	// IMP=0x00000001000cfd04
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000001000cfbe0
