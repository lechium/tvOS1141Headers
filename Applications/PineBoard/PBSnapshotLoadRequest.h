...
+ (id)requestWithBundleIdentifier:(id)arg1;	// IMP=0x000000010002b678
...
- (void).cxx_destruct;	// IMP=0x000000010002bb50
- (unsigned long long)hash;	// IMP=0x000000010002ba0c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010002b7dc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010002b724
