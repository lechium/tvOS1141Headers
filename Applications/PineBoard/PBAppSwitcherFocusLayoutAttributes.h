...
- (id)description;	// IMP=0x000000010006c0b4
- (unsigned long long)hash;	// IMP=0x000000010006be60
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010006bb54
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010006b984
