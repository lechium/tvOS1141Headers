...
- (void).cxx_destruct;	// IMP=0x00000001000a3c18
- (id)_safeLocalizedValue:(id)arg1 withBundle:(id)arg2;	// IMP=0x00000001000a35ec
- (_Bool)isAlive;	// IMP=0x00000001000a34b4
- (void)cancel;	// IMP=0x00000001000a34a4
- (void)didSelectButtonAtIndex:(long long)arg1;	// IMP=0x00000001000a3008
- (_Bool)isLastTextField:(long long)arg1;	// IMP=0x00000001000a2fb4
- (long long)keyboardTypeForTextField:(long long)arg1;	// IMP=0x00000001000a2ec0
- (_Bool)isSecureTextField:(long long)arg1;	// IMP=0x00000001000a2e84
@property(readonly, nonatomic) long long notificationType;
- (void)updateWithMessage:(id)arg1 requestFlags:(int)arg2;	// IMP=0x00000001000a1cec
- (id)initWithMessage:(id)arg1 replyPort:(unsigned int)arg2 requestFlags:(int)arg3;	// IMP=0x00000001000a1c58
