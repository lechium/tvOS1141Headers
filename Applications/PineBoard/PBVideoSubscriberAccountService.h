...
- (void).cxx_destruct;	// IMP=0x0000000100082320
- (void)installAppWithMetadata:(id)arg1;	// IMP=0x00000001000816c0
- (id)initWithRemoteConnection:(id)arg1;	// IMP=0x0000000100081640
- (id)init;	// IMP=0x0000000100081628
