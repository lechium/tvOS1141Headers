...
- (void).cxx_destruct;	// IMP=0x000000010002de20
- (void)_presentVolumeBulletinForRouteWithName:(id)arg1 volumeLevel:(float)arg2;	// IMP=0x000000010002d9bc
- (void)_updateVolume;	// IMP=0x000000010002d09c
- (void)_setNeedsVolumeUpdate;	// IMP=0x000000010002cff8
- (void)bulletinService:(id)arg1 didDismissBulletin:(id)arg2 withReason:(unsigned long long)arg3;	// IMP=0x000000010002cfac
- (void)routingController:(id)arg1 pickedRoutesDidChange:(id)arg2;	// IMP=0x000000010002cec4
- (void)volumeController:(id)arg1 volumeValueDidChange:(float)arg2;	// IMP=0x000000010002cd50
- (void)volumeController:(id)arg1 volumeControlAvailableDidChange:(_Bool)arg2;	// IMP=0x000000010002cbe4
- (void)setVolumeNotificationsEnabled:(_Bool)arg1 forOutputContext:(unsigned long long)arg2;	// IMP=0x000000010002cae4
- (_Bool)volumeSupportedForOutputContext:(unsigned long long)arg1;	// IMP=0x000000010002cac0
- (void)decreaseVolumeForOutputContext:(unsigned long long)arg1;	// IMP=0x000000010002c954
- (void)increaseVolumeForOutputContext:(unsigned long long)arg1;	// IMP=0x000000010002c798
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000010002c474
- (id)init;	// IMP=0x000000010002c45c
