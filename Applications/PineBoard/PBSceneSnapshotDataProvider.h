...
- (void).cxx_destruct;	// IMP=0x0000000100077ee4
- (void)invalidateImage;	// IMP=0x0000000100077e8c
- (id)fetchImage;	// IMP=0x0000000100077ae4
- (id)initWithSceneSnapshot:(id)arg1 scaleFactor:(double)arg2;	// IMP=0x0000000100077934
- (id)init;	// IMP=0x000000010007791c
