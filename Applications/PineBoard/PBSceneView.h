...
- (void).cxx_destruct;	// IMP=0x000000010006fb84
- (void)_updateSceneHostView;	// IMP=0x000000010006f9d0
- (void)disableHosting;	// IMP=0x000000010006f974
- (void)didMoveToSuperview;	// IMP=0x000000010006f924
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010006f604
- (void)_updateBackgroundView;	// IMP=0x000000010006f504
- (id)initWithBundleID:(id)arg1 hasBackground:(_Bool)arg2 requester:(id)arg3;	// IMP=0x000000010006f320
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010006f2d4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010006f290
