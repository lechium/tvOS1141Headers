...
- (void).cxx_destruct;	// IMP=0x00000001000881bc
- (void)_updateRasterization;	// IMP=0x0000000100087f00
- (void)setMaskRect:(struct CGRect)arg1;	// IMP=0x0000000100087d3c
- (void)setBlurRadius:(double)arg1 rect:(struct CGRect)arg2;	// IMP=0x0000000100087988
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100087810
- (void)setAppSwitcherItem:(id)arg1;	// IMP=0x0000000100087308
- (void)layoutSubviews;	// IMP=0x000000010008721c
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0000000100086e3c
- (void)dealloc;	// IMP=0x0000000100086dec
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000869c8
