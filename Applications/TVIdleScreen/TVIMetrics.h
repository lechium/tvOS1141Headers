...
+ (id)sharedInstance;	// IMP=0x00000001000176bc
...
- (void).cxx_destruct;	// IMP=0x0000000100017a2c
- (void)displayOutputStopped;	// IMP=0x00000001000178d0
- (void)displayOutputStarted;	// IMP=0x0000000100017814
- (id)init;	// IMP=0x0000000100017780
