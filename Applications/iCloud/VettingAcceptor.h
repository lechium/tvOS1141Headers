...
- (void).cxx_destruct;	// IMP=0x00000001000190e4
- (void)dealloc;	// IMP=0x000000010001901c
- (void)completeVettingWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100018888
- (void)retrievingDialogCancelled;	// IMP=0x0000000100018830
- (_Bool)retrievingDialogShouldDisplay;	// IMP=0x0000000100018828
- (id)initWithCloudKitURL:(id)arg1;	// IMP=0x0000000100018710
