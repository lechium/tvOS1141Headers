...
- (void).cxx_destruct;	// IMP=0x000000010007b1e0
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000010007affc
- (void)pulseAtBeginTime:(double)arg1;	// IMP=0x000000010007adf4
- (void)layoutSubviews;	// IMP=0x000000010007acec
- (id)initWithMode:(unsigned long long)arg1;	// IMP=0x000000010007ac8c
