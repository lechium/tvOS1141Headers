...
- (void).cxx_destruct;	// IMP=0x000000010007ac7c
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000010007aa98
- (void)pulseAtBeginTime:(double)arg1;	// IMP=0x000000010007a374
- (void)layoutSubviews;	// IMP=0x000000010007a26c
- (id)initWithMode:(unsigned long long)arg1;	// IMP=0x000000010007a20c
