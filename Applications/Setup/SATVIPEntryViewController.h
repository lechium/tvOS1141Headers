...
- (void).cxx_destruct;	// IMP=0x000000010001e5c4
- (void)_didSelectMenu;	// IMP=0x000000010001e57c
- (id)_ipEntryView;	// IMP=0x000000010001e504
- (void)ipEntryViewDidFinishEditing:(id)arg1;	// IMP=0x000000010001e458
@property(copy, nonatomic) NSString *ipAddress;
- (void)setTitle:(id)arg1;	// IMP=0x000000010001e2a8
- (id)preferredFocusEnvironments;	// IMP=0x000000010001e1cc
- (_Bool)becomeFirstResponder;	// IMP=0x000000010001e1b4
- (void)viewDidLayoutSubviews;	// IMP=0x000000010001dfc4
- (void)loadView;	// IMP=0x000000010001db38
