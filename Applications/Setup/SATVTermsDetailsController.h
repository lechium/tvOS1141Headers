...
- (void).cxx_destruct;	// IMP=0x000000010002297c
- (void)tableView:(id)arg1 didUnfocusRowAtIndexPath:(id)arg2;	// IMP=0x00000001000227a8
- (void)tableView:(id)arg1 didFocusRowAtIndexPath:(id)arg2;	// IMP=0x0000000100022714
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x00000001000224d8
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x00000001000220e4
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x00000001000220bc
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x00000001000220b4
@property(readonly, nonatomic) struct CGSize sizeThatFits;
- (id)preferredFocusEnvironments;	// IMP=0x0000000100021f84
- (void)viewDidLayoutSubviews;	// IMP=0x0000000100021d88
- (void)loadView;	// IMP=0x00000001000218d0
