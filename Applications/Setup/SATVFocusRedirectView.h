...
- (_Bool)_containsInertiaSelectionChanges;	// IMP=0x0000000100009d8c
- (void)layoutSubviews;	// IMP=0x0000000100009d20
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100009c68
