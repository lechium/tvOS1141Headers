...
+ (id)stableKey;	// IMP=0x000000010004a504
...
- (void).cxx_destruct;	// IMP=0x000000010004b56c
- (void)setTimeZoneCityID:(id)arg1;	// IMP=0x000000010004b19c
- (id)_dateTimePreferences;	// IMP=0x000000010004b118
- (void)_doneButtonPressed:(id)arg1;	// IMP=0x000000010004b0fc
- (_Bool)_enableAutomaticKeyboardPressDone;	// IMP=0x000000010004b0f4
- (_Bool)_disableAutomaticKeyboardUI;	// IMP=0x000000010004b0ec
- (void)viewController:(id)arg1 didSelectCity:(id)arg2;	// IMP=0x000000010004b0dc
- (void)_textDidChange;	// IMP=0x000000010004b024
@property(readonly, nonatomic) _Bool isConfigured;
- (id)preferredFocusEnvironments;	// IMP=0x000000010004aec0
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000010004ae30
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000010004abcc
- (void)viewDidLoad;	// IMP=0x000000010004aa18
- (void)loadView;	// IMP=0x000000010004a5b0
- (void)autoAdvance;	// IMP=0x000000010004a530
