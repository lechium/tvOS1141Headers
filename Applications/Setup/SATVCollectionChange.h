...
- (void).cxx_destruct;	// IMP=0x0000000100030fb8
- (id)description;	// IMP=0x0000000100030e28
- (id)init;	// IMP=0x0000000100030e10
- (id)initWithChangeKind:(unsigned long long)arg1 sourceIndexes:(id)arg2 destinationIndexes:(id)arg3;	// IMP=0x0000000100030d30
