...
- (void).cxx_destruct;	// IMP=0x00000001000497bc
- (void)setTitle:(id)arg1 subtitle:(id)arg2 languageCode:(id)arg3 animated:(_Bool)arg4;	// IMP=0x0000000100048c8c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100048c20
- (void)layoutSubviews;	// IMP=0x0000000100048b28
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000489cc
