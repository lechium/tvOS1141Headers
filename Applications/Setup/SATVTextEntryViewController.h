...
- (void).cxx_destruct;	// IMP=0x0000000100005474
- (void)_submitButtonAction:(id)arg1;	// IMP=0x0000000100005290
- (void)_handleMenuButton:(id)arg1;	// IMP=0x00000001000051e4
- (void)_textChanged;	// IMP=0x00000001000050cc
- (id)preferredFocusEnvironments;	// IMP=0x0000000100005054
- (void)_doneButtonPressed:(id)arg1;	// IMP=0x0000000100004c00
- (_Bool)_enableAutomaticKeyboardPressDone;	// IMP=0x0000000100004bf8
- (_Bool)_disableAutomaticKeyboardUI;	// IMP=0x0000000100004bf0
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100004b60
- (void)loadView;	// IMP=0x000000010000463c
