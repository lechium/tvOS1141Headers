...
- (void).cxx_destruct;	// IMP=0x0000000100078808
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x0000000100078704
- (id)tableView:(id)arg1 titleForHeaderInSection:(long long)arg2;	// IMP=0x00000001000786a8
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x0000000100078570
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x000000010007851c
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x00000001000784d0
@property(readonly, nonatomic, getter=_dataSource) _SATVAirplay2TableDataSource *dataSource; // @synthesize dataSource=_dataSource;
- (void)viewDidLoad;	// IMP=0x0000000100077858
- (id)initWithHome:(id)arg1;	// IMP=0x00000001000775a4
