...
+ (_Bool)isSupported;	// IMP=0x00000001000424b0
+ (id)stableKey;	// IMP=0x0000000100042484
@property(copy, nonatomic) CDUnknownBlockType completionHandler; // @synthesize completionHandler;
- (void).cxx_destruct;	// IMP=0x0000000100042860
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000001000427e0
- (void)viewDidLoad;	// IMP=0x000000010004254c
