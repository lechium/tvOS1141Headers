...
- (void).cxx_destruct;	// IMP=0x0000000100005b4c
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100005a2c
- (void)layoutSubviews;	// IMP=0x00000001000057fc
- (void)_updateLabels;	// IMP=0x00000001000056fc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000052b0
