...
- (void).cxx_destruct;	// IMP=0x000000010000ad5c
- (void)_updateLayoutProperties;	// IMP=0x000000010000a86c
- (double)_focusedGrowthMagnitude;	// IMP=0x000000010000a7f8
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010000a3c0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010000a2bc
@property(readonly, nonatomic) struct CGSize imageSize;
@property(retain, nonatomic) UIImage *badgeImage;
@property(copy, nonatomic) NSString *title;
- (double)cellCornerRadius;	// IMP=0x000000010000a188
- (void)prepareForReuse;	// IMP=0x000000010000a12c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100009abc
