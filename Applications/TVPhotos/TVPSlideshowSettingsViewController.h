...
- (void).cxx_destruct;	// IMP=0x000000010001c778
- (void)_initializeSlideshowSettings;	// IMP=0x000000010001b790
- (struct CGSize)_getAttributedTextSize:(id)arg1 font:(id)arg2 maxWidth:(double)arg3;	// IMP=0x000000010001b6cc
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x000000010001ae7c
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x000000010001a83c
- (id)tableView:(id)arg1 titleForHeaderInSection:(long long)arg2;	// IMP=0x000000010001a79c
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x000000010001a704
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x000000010001a6e8
- (void)_slideshowThemeChanged:(id)arg1;	// IMP=0x000000010001a198
- (id)preferredFocusEnvironments;	// IMP=0x000000010001a09c
- (void)dealloc;	// IMP=0x000000010001a024
- (void)viewDidLoad;	// IMP=0x0000000100019978
- (void)loadView;	// IMP=0x00000001000198a0
- (void)refreshPhotoAssets:(id)arg1;	// IMP=0x0000000100019860
- (id)init;	// IMP=0x0000000100019798
- (id)initWithPhotoAssets:(id)arg1;	// IMP=0x0000000100019708
