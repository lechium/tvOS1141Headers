...
- (void)updateDelegate:(id)arg1;	// IMP=0x0000000100067ed0
- (void)tableView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000100067e08
- (_Bool)tableView:(id)arg1 canFocusRowAtIndexPath:(id)arg2;	// IMP=0x0000000100067e00
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x0000000100067c28
- (id)init;	// IMP=0x0000000100066ee8
- (id)preferredFocusEnvironments;	// IMP=0x0000000100066e78
