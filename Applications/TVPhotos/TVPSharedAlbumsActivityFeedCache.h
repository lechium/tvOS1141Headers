...
+ (id)sharedInstance;	// IMP=0x000000010000ca90
...
- (void).cxx_destruct;	// IMP=0x000000010000cd44
- (_Bool)loadCache;	// IMP=0x000000010000cb80
- (_Bool)hasFeedInfo;	// IMP=0x000000010000cb10
