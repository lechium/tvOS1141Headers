...
- (void)_updateCachedAssets;	// IMP=0x0000000100007a9c
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010000798c
- (id)requestOptions;	// IMP=0x0000000100007920
- (long long)contentMode;	// IMP=0x0000000100007918
- (struct CGSize)targetSize;	// IMP=0x0000000100007874
- (void)stopPrefetchingAssets;	// IMP=0x0000000100007800
- (void)startPrefetchingAssets;	// IMP=0x00000001000077f4
- (void)dealloc;	// IMP=0x0000000100007670
