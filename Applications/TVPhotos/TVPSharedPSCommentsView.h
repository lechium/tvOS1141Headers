...
- (id)_latestCommentIndexPathForCommentsView;	// IMP=0x0000000100017958
- (void)_scrollToLastComment;	// IMP=0x00000001000178d4
- (void)layoutSubviews;	// IMP=0x0000000100017574
- (id)preferredFocusEnvironments;	// IMP=0x00000001000174d0
- (id)dequeueReusableViewForIdentifier:(id)arg1;	// IMP=0x000000010001742c
- (void)reloadCommentsData;	// IMP=0x00000001000173e8
- (void)registerClass:(Class)arg1 forCommentsWithReuseIdentifier:(id)arg2;	// IMP=0x00000001000172f4
- (void)registerClass:(Class)arg1 forSubheaderWithReuseIdentifier:(id)arg2;	// IMP=0x0000000100017214
- (void)registerClass:(Class)arg1 forHeaderWithReuseIdentifier:(id)arg2;	// IMP=0x0000000100017134
