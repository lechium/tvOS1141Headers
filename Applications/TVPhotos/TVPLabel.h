...
- (void)_clearCachedValues;	// IMP=0x00000001000857c4
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000856f4
- (struct CGRect)textRectForBounds:(struct CGRect)arg1 limitedToNumberOfLines:(long long)arg2;	// IMP=0x00000001000855b4
- (void)setBaselineAdjustment:(long long)arg1;	// IMP=0x0000000100085564
- (void)setAdjustsFontSizeToFitWidth:(_Bool)arg1;	// IMP=0x0000000100085514
- (void)setNumberOfLines:(long long)arg1;	// IMP=0x00000001000854c4
- (void)setLineBreakMode:(long long)arg1;	// IMP=0x0000000100085474
- (void)setFont:(id)arg1;	// IMP=0x0000000100085424
- (void)setText:(id)arg1;	// IMP=0x00000001000853d4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010008530c
