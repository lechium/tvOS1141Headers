...
- (void).cxx_destruct;	// IMP=0x0000000100090cb0
- (unsigned long long)_viewTypeForNumberOfImages:(long long)arg1;	// IMP=0x0000000100090b80
- (unsigned long long)_paradeThreshold;	// IMP=0x0000000100090b78
- (void)_displayPlaceholderView;	// IMP=0x0000000100090878
- (void)_fadeToBlack;	// IMP=0x0000000100090770
- (void)_dissolveToPendingView;	// IMP=0x0000000100090310
- (void)setInOrder:(_Bool)arg1;	// IMP=0x0000000100090214
- (void)setShuffled:(_Bool)arg1;	// IMP=0x000000010009011c
- (void)resume;	// IMP=0x00000001000900ac
- (_Bool)isPaused;	// IMP=0x000000010009002c
- (void)pause;	// IMP=0x000000010008ffbc
- (void)_scrollingParadeViewReadyNotification:(id)arg1;	// IMP=0x000000010008fb48
- (void)_paradeViewReadyNotification:(id)arg1;	// IMP=0x000000010008fa70
- (void)_crossfadeViewReadyNotification:(id)arg1;	// IMP=0x000000010008f99c
- (void)layoutSubviews;	// IMP=0x000000010008f910
- (void)dealloc;	// IMP=0x000000010008f8ac
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010008f6e0
