...
+ (Class)invalidationContextClass;	// IMP=0x000000010002c5e0
+ (Class)layoutAttributesClass;	// IMP=0x000000010002c0f8
...
- (void).cxx_destruct;	// IMP=0x000000010002d454
- (void)_removeFocusContainerGuideForSection:(long long)arg1;	// IMP=0x000000010002d17c
- (id)_focusContainerGuideForSection:(long long)arg1;	// IMP=0x000000010002d014
- (void)_updateFocusContainerGuides;	// IMP=0x000000010002cc1c
- (struct CGSize)_titleAdjustmentSize;	// IMP=0x000000010002cbd0
- (struct CGRect)_titleFrame;	// IMP=0x000000010002c9e8
- (struct CGPoint)targetContentOffsetForProposedContentOffset:(struct CGPoint)arg1 withScrollingVelocity:(struct CGPoint)arg2;	// IMP=0x000000010002c65c
- (struct CGSize)collectionViewContentSize;	// IMP=0x000000010002c5f4
- (void)invalidateLayoutWithContext:(id)arg1;	// IMP=0x000000010002c22c
- (_Bool)shouldInvalidateLayoutForBoundsChange:(struct CGRect)arg1;	// IMP=0x000000010002c1b4
- (void)_adjustLayoutAttributes:(id)arg1;	// IMP=0x000000010002c10c
- (void)_applyCustomAttributesToAttributes:(id)arg1;	// IMP=0x000000010002bfac
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x000000010002bf28
- (id)layoutAttributesForSupplementaryViewOfKind:(id)arg1 atIndexPath:(id)arg2;	// IMP=0x000000010002be34
- (id)_layoutAttributesForTitle;	// IMP=0x000000010002bd6c
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x000000010002ba1c
- (void)prepareLayout;	// IMP=0x000000010002b8f4
