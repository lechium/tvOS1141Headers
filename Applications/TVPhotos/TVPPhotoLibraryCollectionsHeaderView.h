...
- (void).cxx_destruct;	// IMP=0x0000000100087b8c
- (struct CGSize)_getAttributedStringSizeForText:(id)arg1 font:(id)arg2;	// IMP=0x0000000100087a6c
- (void)layoutSubviews;	// IMP=0x00000001000878a4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100087604
