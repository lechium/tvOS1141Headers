...
- (void).cxx_destruct;	// IMP=0x0000000100065a4c
- (void)_detachMotionEffects;	// IMP=0x000000010006592c
- (void)_attachMotionEffects;	// IMP=0x00000001000656b4
- (void)layoutSubviews;	// IMP=0x00000001000652d0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010006511c
- (_Bool)canBecomeFocused;	// IMP=0x0000000100065114
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100064ef0
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100064ccc
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100064aa8
- (_Bool)_unapplyMotionEffect:(id)arg1;	// IMP=0x0000000100064a70
- (_Bool)_applyKeyPathsAndRelativeValues:(id)arg1 forMotionEffect:(id)arg2;	// IMP=0x0000000100064984
- (id)init;	// IMP=0x00000001000644dc
