...
- (void).cxx_destruct;	// IMP=0x000000010000de28
- (void)configureUIControls;	// IMP=0x000000010000d858
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010000d63c
- (void)_onSelectSignIn:(id)arg1;	// IMP=0x000000010000d5dc
- (void)layoutSubviews;	// IMP=0x000000010000d1d8
- (id)preferredFocusEnvironments;	// IMP=0x000000010000d000
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010000cd98
