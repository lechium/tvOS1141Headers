...
- (void).cxx_destruct;	// IMP=0x000000010002ef40
- (long long)_previousSectionWithItems;	// IMP=0x000000010002ecbc
- (long long)_nextSectionWithItems;	// IMP=0x000000010002ec2c
- (_Bool)_scrollToPreviousItem;	// IMP=0x000000010002eb1c
- (_Bool)_scrollToNextItem;	// IMP=0x000000010002ea08
- (_Bool)_performPageScrollByEvaluatingOffset:(double)arg1;	// IMP=0x000000010002e954
- (void)_resetPageScrollOffsets;	// IMP=0x000000010002e90c
- (void)_startPageScroll:(double)arg1;	// IMP=0x000000010002e7fc
- (void)_handleDownScrollButtonGesture:(id)arg1;	// IMP=0x000000010002e5c4
- (void)_handleUpScrollButtonGesture:(id)arg1;	// IMP=0x000000010002e3fc
- (id)preferredFocusedView;	// IMP=0x000000010002e3f8
- (_Bool)canBecomeFocused;	// IMP=0x000000010002e3f0
- (void)reloadData;	// IMP=0x000000010002e35c
@property(readonly, nonatomic) long long currentSection;
@property(readonly, nonatomic) long long currentIndex;
- (void)setFlowLayoutDefaultAttributes:(id)arg1;	// IMP=0x000000010002e2c8
- (void)scrollToItemAtIndexPath:(id)arg1 atScrollPosition:(unsigned long long)arg2 animated:(_Bool)arg3;	// IMP=0x000000010002e18c
- (id)initWithFrame:(struct CGRect)arg1 collectionViewLayout:(id)arg2;	// IMP=0x000000010002de88
