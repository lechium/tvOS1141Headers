...
- (void).cxx_destruct;	// IMP=0x000000010005f6dc
- (void)_updateImageViewWithPlaceholderImageIfNeeded;	// IMP=0x000000010005f578
- (void)_setImage:(id)arg1;	// IMP=0x000000010005f404
- (id)_imageView;	// IMP=0x000000010005f26c
- (void)_loadImage;	// IMP=0x000000010005eb20
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000010005e9ac
@property(nonatomic) double cornerRadius;
- (void)setImageProxy:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010005e5bc
@property(retain, nonatomic) UIImage *image;
- (void)willMoveToWindow:(id)arg1;	// IMP=0x000000010005e4b0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010005e408
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x000000010005e394
- (void)setContentMode:(long long)arg1;	// IMP=0x000000010005e370
- (void)layoutSubviews;	// IMP=0x000000010005e304
- (long long)contentMode;	// IMP=0x000000010005e2ec
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000010005e2d4
- (void)dealloc;	// IMP=0x000000010005e268
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010005e17c
