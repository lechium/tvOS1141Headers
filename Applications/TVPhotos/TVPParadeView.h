...
- (void).cxx_destruct;	// IMP=0x000000010000ca00
- (id)_sublayerWithAnimation:(id)arg1;	// IMP=0x000000010000c728
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000010000c594
- (void)_stopAnimations;	// IMP=0x000000010000c43c
- (void)_updateAnimationForLayer:(id)arg1 timeOffset:(double)arg2;	// IMP=0x000000010000bd6c
- (void)_updateAnimations;	// IMP=0x000000010000bbd8
- (void)_updateKeyframes;	// IMP=0x000000010000b8c4
- (id)_createLayerForImage:(struct CGImage *)arg1;	// IMP=0x000000010000b838
- (id)_imageProxiesToLoad;	// IMP=0x000000010000b808
- (long long)_maximumImageCount;	// IMP=0x000000010000b800
- (_Bool)isPreviewPaused;	// IMP=0x000000010000b730
- (void)setPreviewPaused:(_Bool)arg1;	// IMP=0x000000010000b724
- (void)_applicationDidFinishSuspensionNotification:(id)arg1;	// IMP=0x000000010000b228
- (void)_applicationWillEnterForegroundNotification:(id)arg1;	// IMP=0x000000010000b1d4
- (void)didMoveToSuperview;	// IMP=0x000000010000b180
- (void)layoutSubviews;	// IMP=0x000000010000b0d8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010000ae7c
