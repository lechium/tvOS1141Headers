...
- (void)_crossfadeToImage:(id)arg1;	// IMP=0x000000010003356c
- (void)_loadNextImage:(id)arg1;	// IMP=0x00000001000334c4
- (void)_startTimer;	// IMP=0x000000010003340c
- (void)layoutSubviews;	// IMP=0x0000000100033070
- (void)didMoveToSuperview;	// IMP=0x0000000100033008
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100032f00
