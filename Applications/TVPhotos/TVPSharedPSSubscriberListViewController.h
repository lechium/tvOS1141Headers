...
+ (id)_sharedAlbumSubscribersFromAlbum:(id)arg1;	// IMP=0x00000001000432ec
...
- (void).cxx_destruct;	// IMP=0x00000001000435e4
- (void)_onSelectActionButton:(id)arg1;	// IMP=0x0000000100042e14
- (void)photoLibraryDidChange:(id)arg1;	// IMP=0x0000000100042bc8
- (struct CGSize)formSize;	// IMP=0x0000000100042bb4
- (void)viewDidLayoutSubviews;	// IMP=0x0000000100042a9c
- (void)viewDidLoad;	// IMP=0x000000010004262c
- (void)setMenuGestureRcognizer:(id)arg1;	// IMP=0x0000000100042518
