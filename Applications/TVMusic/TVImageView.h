...
- (void).cxx_destruct;	// IMP=0x0000000100019728
- (void)_updateImageViewWithPlaceholderImageIfNeeded;	// IMP=0x00000001000195c4
- (void)_setImage:(id)arg1;	// IMP=0x0000000100019450
- (id)_imageView;	// IMP=0x00000001000192b8
- (void)_loadImage;	// IMP=0x0000000100018bac
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000100018a38
@property(nonatomic) double cornerRadius;
- (void)setImageProxy:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100018648
@property(retain, nonatomic) UIImage *image;
- (void)willMoveToWindow:(id)arg1;	// IMP=0x000000010001853c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100018494
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x0000000100018420
- (void)setContentMode:(long long)arg1;	// IMP=0x00000001000183fc
- (void)layoutSubviews;	// IMP=0x0000000100018390
- (long long)contentMode;	// IMP=0x0000000100018378
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000100018360
- (void)dealloc;	// IMP=0x00000001000182f4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100018208
