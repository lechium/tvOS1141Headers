...
- (void)_fetchPhotoAssetsForAlbumArtwork:(CDUnknownBlockType)arg1;	// IMP=0x000000010003c414
- (void)registerRemotePhotoServer:(id)arg1;	// IMP=0x000000010003c338
- (void)photoAssetsWithOptions:(id)arg1 responseBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000010003c298
