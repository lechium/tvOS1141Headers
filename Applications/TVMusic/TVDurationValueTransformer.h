...
+ (_Bool)allowsReverseTransformation;	// IMP=0x000000010003f1cc
+ (Class)transformedValueClass;	// IMP=0x000000010003f1b8
+ (void)load;	// IMP=0x000000010003f07c
...
- (void).cxx_destruct;	// IMP=0x000000010003f38c
- (id)transformedValue:(id)arg1;	// IMP=0x000000010003f1d4
- (id)init;	// IMP=0x000000010003f0d8
