...
- (void)_clearCachedValues;	// IMP=0x000000010004d96c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010004d89c
- (struct CGRect)textRectForBounds:(struct CGRect)arg1 limitedToNumberOfLines:(long long)arg2;	// IMP=0x000000010004d75c
- (_Bool)canBecomeFocused;	// IMP=0x000000010004d750
- (void)setBaselineAdjustment:(long long)arg1;	// IMP=0x000000010004d700
- (void)setAdjustsFontSizeToFitWidth:(_Bool)arg1;	// IMP=0x000000010004d6b0
- (void)setNumberOfLines:(long long)arg1;	// IMP=0x000000010004d660
- (void)setLineBreakMode:(long long)arg1;	// IMP=0x000000010004d610
- (void)setFont:(id)arg1;	// IMP=0x000000010004d5c0
- (void)setText:(id)arg1;	// IMP=0x000000010004d570
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010004d4a8
