...
+ (struct CGSize)getAttributedTextSize:(id)arg1 font:(id)arg2 maxWidth:(double)arg3;	// IMP=0x000000010006fe34
...
- (void).cxx_destruct;	// IMP=0x0000000100070088
- (void)configureUIControls;	// IMP=0x000000010006f99c
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010006f780
- (void)_onSelectSignIn:(id)arg1;	// IMP=0x000000010006f720
- (void)layoutSubviews;	// IMP=0x000000010006f31c
- (id)preferredFocusEnvironments;	// IMP=0x000000010006f144
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010006eedc
