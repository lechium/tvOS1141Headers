...
+ (id)playlistViewFromElement:(id)arg1 existingView:(id)arg2;	// IMP=0x000000010009f16c
...
- (void).cxx_destruct;	// IMP=0x00000001000a14e8
- (id)_randomColor;	// IMP=0x00000001000a134c
- (void)_configureLabel:(id)arg1 withTextElement:(id)arg2 maxWidth:(double)arg3;	// IMP=0x00000001000a11b8
- (struct CGRect)_scaleRect:(struct CGRect)arg1 withStyle:(id)arg2;	// IMP=0x00000001000a109c
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001000a0eac
- (void)layoutSubviews;	// IMP=0x00000001000a0dc8
- (void)layoutWithElement:(id)arg1;	// IMP=0x000000010009f8ec
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010009f860
- (void)prepareForReuse;	// IMP=0x000000010009f80c
- (_Bool)canBecomeFocused;	// IMP=0x000000010009f804
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010009f238
