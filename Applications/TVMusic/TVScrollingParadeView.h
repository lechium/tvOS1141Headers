...
- (void).cxx_destruct;	// IMP=0x0000000100090378
- (void)_stopAnimations;	// IMP=0x00000001000901a4
- (void)_startAnimations;	// IMP=0x000000010008f820
- (void)_addImageToAnimationContainer:(id)arg1;	// IMP=0x000000010008f550
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000010008f540
- (void)layoutSubviews;	// IMP=0x000000010008edb0
- (void)didMoveToWindow;	// IMP=0x000000010008ecf4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010008ec18
