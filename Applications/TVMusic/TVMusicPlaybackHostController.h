...
- (id)preferredFocusEnvironments;	// IMP=0x00000001000115c4
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00000001000114d4
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100011280
- (id)initWithPlayer:(id)arg1;	// IMP=0x00000001000111f8
