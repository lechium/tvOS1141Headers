...
- (void).cxx_destruct;	// IMP=0x000000010009a8e0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010009a6fc
- (struct CGRect)_messageViewFrameWithBounds:(struct CGRect)arg1;	// IMP=0x000000010009a500
- (struct CGRect)_imageViewFrameWithBounds:(struct CGRect)arg1;	// IMP=0x000000010009a47c
- (struct CGRect)_titleViewFrameWithBounds:(struct CGRect)arg1;	// IMP=0x000000010009a378
- (void)layoutSubviews;	// IMP=0x000000010009a28c
