...
- (void).cxx_destruct;	// IMP=0x000000010001a660
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010001a54c
- (void)_addHeadingLabel;	// IMP=0x000000010001a380
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010001a25c
