...
- (void).cxx_destruct;	// IMP=0x0000000100003824
- (void)_peripheralStateDidChangeNotification:(id)arg1;	// IMP=0x00000001000035f4
- (void)_handleRemoteDidPair;	// IMP=0x00000001000032b8
- (void)_handlePairingTimeout;	// IMP=0x0000000100003188
- (void)unpairAllRemotes;	// IMP=0x0000000100002e04
- (void)stopProximityPairing;	// IMP=0x0000000100002ce0
- (void)startProximityPairing;	// IMP=0x00000001000028f0
- (void)dealloc;	// IMP=0x00000001000027f0
