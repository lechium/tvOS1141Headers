...
@interface UIStatusBarServerThread : NSThread {
	...
	SCD_Struct_UI60 _statusBarData;
	SCD_Struct_UI60 _composedStatusBarData;
	SCD_Struct_UI84 _overrides;
...
-(SCD_Struct_UI61*)_statusBarOverrideData;
-(void)_postStatusBarData:(SCD_Struct_UI60*)arg1 actions:(int)arg2 animated:(BOOL)arg3 ;
...
-(void)_postStatusBarOverrideData:(SCD_Struct_UI61*)arg1 ;
