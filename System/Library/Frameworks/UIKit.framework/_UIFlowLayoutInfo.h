...
@interface _UIFlowLayoutInfo : NSObject {
	...
	SCD_Struct_UI106 _rowAlignmentOptions;
	CGSize _contentSize;
...
@property (assign,nonatomic) SCD_Struct_UI106 rowAlignmentOptions;                    //@synthesize rowAlignmentOptions=_rowAlignmentOptions - In the implementation block
