...
@class NSDictionary, NSArray, _UIScreenFixedCoordinateSpace, UITraitCollection, FBSDisplayConfiguration, UISoftwareDimmingWindow, _UIFocusScrollManager, _UIFocusMovementPerformer, _UIScreenFocusSystemManager, UIFocusSystem, _UIScreenBoundingPathUtilities, UIWindow, UIScreenMode, UIView, NSString;
...
@interface UIScreen : NSObject <UICoordinateSpace, _UITraitEnvironmentInternal, _UIFocusEnvironmentInternal, _UIFocusRegionContainer, _UIFocusEnvironmentPrivate, UITraitEnvironment> {
	...
	SCD_Struct_UI47 _carPlayHumanPresenceStatus;
