...
+(const SCD_Struct_UI60*)getStatusBarData;
...
+(void)postStatusBarData:(const SCD_Struct_UI60*)arg1 withActions:(int)arg2 ;
+(void)postStatusBarOverrideData:(SCD_Struct_UI61*)arg1 ;
+(void)permanentizeStatusBarOverrideData;
+(SCD_Struct_UI61*)getStatusBarOverrideData;
+(int)getStyleOverrides;
-(void)dealloc;
-(id<UIStatusBarServerClient>)statusBar;
-(void)setStatusBar:(id<UIStatusBarServerClient>)arg1 ;
-(void)_receivedStatusBarData:(SCD_Struct_UI60*)arg1 actions:(int)arg2 animated:(BOOL)arg3 ;
