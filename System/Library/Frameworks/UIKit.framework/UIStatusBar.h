...
@class UIStatusBarBackgroundView, UIStatusBarForegroundView, UILabel, UIView, NSString, NSMutableArray, UIStatusBarStyleAttributes, UIColor, UIStatusBarStyleAnimationParameters, NSNumber, NSMutableSet, UIStatusBarWindow;
...
@interface UIStatusBar : UIStatusBar_Base <UIStatusBarServerClient, UIStatusBarStateObserver> {
	...
	SCD_Struct_UI60 _currentRawData;
...
+(void)getData:(SCD_Struct_UI60*)arg1 forRequestedData:(const SCD_Struct_UI60*)arg2 withOverrides:(const SCD_Struct_UI61*)arg3 ;
...
-(void)statusBarStateProvider:(id)arg1 didPostStatusBarData:(const SCD_Struct_UI60*)arg2 withActions:(int)arg3 ;
