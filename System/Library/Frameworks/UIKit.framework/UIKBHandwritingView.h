...
@property (assign,nonatomic) SCD_Struct_UI77 previousPoint;                                      //@synthesize previousPoint=_previousPoint - In the implementation block
...
-(void)setPreviousPoint:(SCD_Struct_UI77)arg1 ;
-(BOOL)initialPointPosted;
-(SCD_Struct_UI77)previousPoint;
