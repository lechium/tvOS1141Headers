...
@class UISwipeDismissalGestureRecognizer, UIPanGestureRecognizer, UISwipeActionController, NSString;
...
@interface UISwipeHandler : NSObject <UIGestureRecognizerDelegate> {
	...
	SCD_Struct_UI56 _currentSwipeConfig;
...
@property (nonatomic,readonly) SCD_Struct_UI56 currentSwipeConfig; 
...
-(SCD_Struct_UI57)_currentSwipeInfoWithTargetOffset:(double)arg1 animated:(BOOL)arg2 usingSpringWithStiffness:(double)arg3 ;
-(id)initWithSwipeController:(id)arg1 ;
-(BOOL)isInteracting;
-(void)resetSwipe;
-(SCD_Struct_UI56)currentSwipeConfig;
