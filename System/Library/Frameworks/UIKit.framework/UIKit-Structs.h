...
typedef struct {
	SCD_Struct_UI33 field1;
	SCD_Struct_UI33 field2;
...
typedef struct {
	SCD_Struct_UI108 dampingRatioParameters;
	SCD_Struct_UI108 responseParameters;
	SCD_Struct_UI108 targetParameters;
...
typedef struct {
	SCD_Struct_UI111 position;
	 color;
} SCD_Struct_UI112;

typedef struct {
	SCD_Struct_UI108 field1;
	SCD_Struct_UI108 field2;
	SCD_Struct_UI108 field3;
	BOOL field4;
	BOOL field5;
	BOOL field6;
} SCD_Struct_UI113;
