...
@interface UIViewController : UIResponder <_UIViewServiceDeputy, NSExtensionRequestHandling, UIViewControllerPresenting, _UITraitEnvironmentInternal, _UIContentContainerInternal, _UIFocusEnvironmentInternal, NSCoding, UIAppearanceContainer, UITraitEnvironment, UIContentContainer, UIFocusEnvironment> {
	...
	SCD_Struct_UI28 _presentationSizeClassPair;
...
@property (nonatomic,readonly) SCD_Struct_UI28 __sizeClassPair; 
...
@property (assign,setter=_setPresentationSizeClassPair:,getter=_presentationSizeClassPair,nonatomic) SCD_Struct_UI28 presentationSizeClassPair;                                                    //@synthesize presentationSizeClassPair=_presentationSizeClassPair - In the implementation block
...
-(void)_setPresentationSizeClassPair:(SCD_Struct_UI28)arg1 ;
...
-(void)_setHostAuditToken:(SCD_Struct_UI30)arg1 ;
...
-(SCD_Struct_UI30)_hostAuditToken;
