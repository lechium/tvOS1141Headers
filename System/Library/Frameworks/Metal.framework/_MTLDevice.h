...
@property (readonly) const SCD_Struct_MT13* limits; 
...
-(SCD_Struct_MT14)libraryCacheStats;
-(SCD_Struct_MT14)pipelineCacheStats;
...
-(id)newLibraryWithCIFilters:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_MT15*)arg2 error:(id*)arg3 ;
...
-(SCD_Struct_MT16)pipelineFlagsWithVertexVariant:(id)arg1 fragmentVariant:(id)arg2 ;
-(SCD_Struct_MT17)pipelineFlagsWithComputeVariant:(NSObject*)arg1 ;
...
-(id)newComputePipelineStateWithImageFilterFunctionsSPI:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_MT15*)arg2 error:(id*)arg3 ;
