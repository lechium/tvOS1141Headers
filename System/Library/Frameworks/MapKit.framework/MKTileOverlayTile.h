...
@property (assign,nonatomic) SCD_Struct_MK39 path;              //@synthesize path=_path - In the implementation block
...
-(SCD_Struct_MK39)path;
-(NSData *)image;
-(void)setPath:(SCD_Struct_MK39)arg1 ;
@end
