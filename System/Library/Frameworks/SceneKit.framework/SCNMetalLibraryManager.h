...
-(void)libraryForSourceCode:(id)arg1 preprocessorsMacros:(id)arg2 programDelegate:(_C3DFXProgramDelegate*)arg3 programDesc:(SCD_Struct_SC82*)arg4 async:(BOOL)arg5 group:(id)arg6 completionHandler:(/*^block*/id)arg7 ;
