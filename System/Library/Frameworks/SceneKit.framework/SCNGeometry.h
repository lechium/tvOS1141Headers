...
@interface SCNGeometry : NSObject <SCNAnimatable, SCNBoundingVolume, SCNShadable, NSCopying, NSSecureCoding> {
	...
	SCD_Struct_SC99 _subdivisionSettings;
...
@property (nonatomic,retain) SCNGeometryTessellator * tessellator;                 //@synthesize tessellator=_tessellator - In the implementation block
...
-(SCD_Struct_SC99)_subdivisionSettings;
-(void)set_subdivisionSettings:(SCD_Struct_SC99)arg1 ;
