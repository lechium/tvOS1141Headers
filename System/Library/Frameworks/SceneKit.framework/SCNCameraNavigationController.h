...
@interface SCNCameraNavigationController : NSObject <SCNEventHandler, SCNCameraControllerDelegate> {
	...
	SCD_Union_SC100 _sceneBoundingSphere;
	 _translationOrigin;
	float _initialZoom;
	...
	SCD_Struct_SC101 _stickyAxis;
	SCD_Struct_SC102 _target;
	SCD_Struct_SC103 _inertia;
	SCD_Struct_SC111* _keyboard;
	SCD_Struct_SC102 _scrollWheelModifiers;
