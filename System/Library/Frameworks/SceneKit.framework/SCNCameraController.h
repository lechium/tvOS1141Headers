...
@interface SCNCameraController : NSObject {
	...
	SCD_Struct_SC117 _orientationState;
	SCD_Struct_SC84 _inputLocation;
	SCD_Struct_SC84 _arcball;
	SCD_Struct_SC118 _inertia;
	 _up;
	 _target;
	 _minimumAngles;
	 _maximumAngles;
...
-(SCD_Struct_SC84)unrolledWorldOrientation:(out float*)arg1 ;
...
-(SCD_Struct_SC84)_orientationForMode;
-(SCD_Struct_SC84)_convertRotationFromWorldToPointOfView:(SCD_Struct_SC84)arg1 ;
