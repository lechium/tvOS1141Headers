...
@class <MTLBuffer>, SCNPhysicsBody, <MTLTexture>, <MTLSamplerState>, <MTLRenderPipelineState>, <MTLCommandBuffer>, <MTLRenderCommandEncoder>, SCNMetalMesh, SCNMetalMeshElement, SCNMetalShadable, SCNMetalRenderPipeline, NSMutableDictionary, NSDictionary, NSTimer, NSArray, NSMutableSet;
...
typedef struct {
	...
	SCD_Struct_SC84 initialOrientationWorld;
} SCD_Struct_SC117;
