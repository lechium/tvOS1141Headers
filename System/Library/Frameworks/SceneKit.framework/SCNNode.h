...
@property (assign,nonatomic) SCD_Struct_SC84 simdOrientation; 
...
@property (assign,nonatomic) SCD_Struct_SC84 simdWorldOrientation; 
...
-(void)_updateAffine;
-()simdRotation;
-(SCD_Struct_SC84)simdWorldOrientation;
-(void)setSimdWorldOrientation:(SCD_Struct_SC84)arg1 ;
-(SCD_Struct_SC84)simdOrientation;
-(SCD_Struct_SC84)_quaternion;
-(void)setSimdOrientation:(SCD_Struct_SC84)arg1 ;
-()simdEulerAngles;
...
-(void)_setQuaternion:(SCD_Struct_SC84)arg1 ;
-(1)_euler;
...
-(void)simdLocalRotateBy:(SCD_Struct_SC84)arg1 ;
-(void)simdRotateBy:(SCD_Struct_SC84)arg1 ;
-(SCNVector3)worldUp;
