...
@property (nonatomic,readonly) SCD_Struct_AV78 pixelAspectRatio; 
@property (nonatomic,readonly) SCD_Struct_AV79 edgeWidths; 
...
-(SCD_Struct_AV79)edgeWidths;
-(BOOL)highQualityRendering;
-(CGSize)size;
-(void)dealloc;
-(SCD_Struct_AV78)pixelAspectRatio;
