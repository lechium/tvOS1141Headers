...
@class MNNavigationAudioSession, MNVoiceEvent, MNVoiceEventQueue, NSMutableArray, VSSpeechRequest, AVAudioPlayer, NSObject, NSTimer, NSString, NSLocale, NSBundle, NSHashTable, VSSpeechSynthesizer;
