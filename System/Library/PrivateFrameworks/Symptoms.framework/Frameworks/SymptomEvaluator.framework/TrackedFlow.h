...
@interface TrackedFlow : TrackedFlowCounts {
	...
	SCD_Struct_Tr37* _currentActivityMap;
	BOOL _closedOut;
	BOOL _isNiced;
	BOOL _isRNF;
...
@property (readonly) SCD_Struct_Tr37* currentActivityMap;                                     //@synthesize currentActivityMap=_currentActivityMap - In the implementation block
+(void)initialize;
+(void)dumpState;
...
-(SCD_Struct_Tr37*)currentActivityMap;
