...
@class NSString, UILabel, UIButton, NSLayoutConstraint, SFAirDropIconView, SFAirDropActiveIconView, NSArray, UICollectionView, UICollectionViewFlowLayout, SFPersonCollectionViewCell, NSCache, SFAirDropBrowser, NSMutableDictionary, SFWirelessSettingsController, NSMutableOrderedSet, NSOperationQueue, NSMutableArray, UIVisualEffectView, UIFocusContainerGuide, NSMapTable, NSObject;
