...
@interface VCConnectionManager : NSObject <VCConnectionHealthMonitorDelegate> {
	...
	SCD_Struct_VC53 _localConnectionStats;
	SCD_Struct_VC53 _remoteConnectionStats;
...
-(void)updateConnectionStatsWithIndicatorNoPackets:(SCD_Struct_VC53*)arg1 ;
-(void)updateConnectionStatsWithIndicatorNone:(SCD_Struct_VC53*)arg1 ;
-(void)updateConnectionStatsWithIndicatorPrimaryImproved:(SCD_Struct_VC53*)arg1 ;
