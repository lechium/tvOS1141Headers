...
@class NSArray, HAPAccessoryServerBrowserRelay, HMDMediaBrowser, NSMutableSet, NSObject, NSUUID, HMFMessageDispatcher, HMDHomeManager, NSMapTable, NSMutableArray, HAPAccessoryServerBrowserIP, HAPAccessoryServerBrowserBTLE, HMDAuthServer, HMFTimer, NSString, NSHashTable;
