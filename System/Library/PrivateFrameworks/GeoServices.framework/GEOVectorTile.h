...
@interface GEOVectorTile : NSObject {
	...
	SCD_Struct_GE131* _linesLabelAnnotations;
	unsigned long long _linesLabelAnnotationCount;
	SCD_Struct_GE132* _linesAnnotationBezierVertices;
	SCD_Struct_GE68* _coastlines;
	unsigned long long _coastlinesCount;
	SCD_Struct_GE133* _polygons;
	...
	SCD_Struct_GE132* _lineVertices;
	SCD_Struct_GE132* _polygonVertices;
	SCD_Struct_GE132* _coastlineVertices;
	SCD_Struct_GE132* _footprintVertices;
	SCD_Struct_GE132* _hiResFootprintVertices;
	SCD_Struct_GE132* _venuesVertices;
	...
	SCD_Struct_GE132* _transitVertices;
	...
	SCD_Struct_GE131* _transitLinkLabelAnnotations;
	unsigned long long _transitLinkLabelAnnotationCount;
	SCD_Struct_GE132* _transitLinkAnnotationBezierVertices;
...
@property (nonatomic,readonly) SCD_Struct_GE131* linesLabelAnnotations;                            //@synthesize linesLabelAnnotations=_linesLabelAnnotations - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE132* linesAnnotationBezierVertices;                    //@synthesize linesAnnotationBezierVertices=_linesAnnotationBezierVertices - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE133* polygons;                                         //@synthesize polygons=_polygons - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE134* venues;                                           //@synthesize venues=_venues - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE135* venueBuildings;                                   //@synthesize venueBuildings=_venueBuildings - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE132* venueVertices;                                    //@synthesize venuesVertices=_venuesVertices - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE136* venueLevels;                                      //@synthesize venueLevels=_venueLevels - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE137* venueComponents;                                  //@synthesize venueComponents=_venueComponents - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE98* buildingFootprints;                                //@synthesize buildingFootprints=_buildingFootprints - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE98* hiResBuildingFootprints;                           //@synthesize hiResBuildingFootprints=_hiResBuildingFootprints - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE127* junctions;                                        //@synthesize junctions=_junctions - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE132* lineVertices; 
...
@property (nonatomic,readonly) SCD_Struct_GE132* transitVertices;                                  //@synthesize transitVertices=_transitVertices - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE132* transitStationTransferVertices;                   //@synthesize transitStationTransferVertices=_transitStationTransferVertices - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE127* transitJunctions;                                 //@synthesize transitJunctions=_transitJunctions - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE131* transitLinkLabelAnnotations;                      //@synthesize transitLinkLabelAnnotations=_transitLinkLabelAnnotations - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE132* transitLinkAnnotationBezierVertices;              //@synthesize transitLinkAnnotationBezierVertices=_transitLinkAnnotationBezierVertices - In the implementation block
...
-(void)forEachEdgeOnJunction:(const SCD_Struct_GE127*)arg1 visitor:(/*^block*/id)arg2 ;
-(SCD_Struct_GE98*)buildingFootprints;
-(unsigned long long)buildingFootprintsCount;
-(SCD_Struct_GE132*)transitVertices;
-(unsigned long long)linesCount;
-(void)forEachPolygon:(/*^block*/id)arg1 ;
-(void)forEachPoint:(/*^block*/id)arg1 ;
-(SCD_Struct_GE142*)transitPointsOnRoad;
-(void)forEachTransitLinkOnJunction:(const SCD_Struct_GE127*)arg1 visitor:(/*^block*/id)arg2 ;
-(id)initWithTileData:(id)arg1 localizationData:(id)arg2 tileKey:(const GEOTileKey*)arg3 ;
-(SCD_Struct_GE132*)lineVertices;
...
-(SCD_Struct_GE131*)transitLinkLabelAnnotations;
-(unsigned long long)transitLinkLabelAnnotationCount;
-(SCD_Struct_GE132*)transitLinkAnnotationBezierVertices;
...
-(BOOL)_readVenues:(SCD_Struct_GE158*)arg1 key:(const GEOTileKey*)arg2 ;
...
-(BOOL)_readVenueMZROverride:(SCD_Struct_GE158*)arg1 ;
...
-(BOOL)_decodeTransitLabelsFromStream:(SCD_Struct_GE159*)arg1 count:(unsigned long long)arg2 firstFeature:(SCD_Struct_GE40*)arg3 featureStride:(unsigned long long)arg4 ;
-(BOOL)_decodeLabelTextPlacementsFromStream:(SCD_Struct_GE159*)arg1 count:(unsigned long long)arg2 firstFeature:(SCD_Struct_GE42*)arg3 featureStride:(unsigned long long)arg4 tilePrecision:(unsigned char)arg5 ;
-(void)dealloc;
-(id)description;
@end
