...
@interface BWDepthConverterNode : BWNode {
	...
	float _baseline;
	SCD_Struct_BW39 _identityExtrinsicMatrix;
	SCD_Struct_BW39 _infraredProjectorExtrinsicMatrix;
	float _depthPixelSizeInMicrons;
	int _depthAccuracy;
	SCD_Struct_BW40 _depthLensDistortionCorrectionBasePolynomial;
	SCD_Struct_BW40 _depthLensDistortionCorrectionDynamicPolynomial;
...
-(int)_computeConversionParametersFromSampleBuffer:(opaqueCMSampleBufferRef)arg1 convertOptionsOut:(SCD_Struct_BW43*)arg2 ;
-(int)_convertDepthDisparityToFloat_NEON:(CVBufferRef)arg1 dst:(CVBufferRef)arg2 options:(SCD_Struct_BW43*)arg3 ;
-(int)_convertDepthDisparityToFloat_C:(CVBufferRef)arg1 dst:(CVBufferRef)arg2 options:(SCD_Struct_BW43*)arg3 ;
...
-(int)_convertU16toFloatForImage_NEON:(CVBufferRef)arg1 dst:(CVBufferRef)arg2 options:(SCD_Struct_BW43*)arg3 ;
