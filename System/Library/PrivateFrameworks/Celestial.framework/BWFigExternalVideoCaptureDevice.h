...
-(int)setWhiteBalanceModeLockedWithGains:(SCD_Struct_BW25)arg1 requestID:(int)arg2 ;
...
-(SCD_Struct_BW25)deviceWhiteBalanceGains;
-(SCD_Struct_BW25)grayWorldDeviceWhiteBalanceGains;
