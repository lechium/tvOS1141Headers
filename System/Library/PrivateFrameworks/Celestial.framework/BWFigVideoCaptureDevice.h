...
@interface BWFigVideoCaptureDevice : BWCaptureDevice <BWZoomCompletionDelegate, BWPortraitSceneMonitor> {
	...
	SCD_Struct_BW103 _currentFrameStatistics;
	...
	SCD_Struct_Fi73 _deviceWhiteBalanceGains;
	SCD_Struct_Fi73 _grayWorldWhiteBalanceGains;
	...
	SCD_Struct_Fi72 _smartCameraSceneHints;
...
-(int)setWhiteBalanceModeLockedWithGains:(SCD_Struct_Fi73)arg1 requestID:(int)arg2 ;
...
-(void)_serviceBravoStreamSelectionWithSampleBuffer:(opaqueCMSampleBufferRef)arg1 fromCaptureStream:(id)arg2 frameStatistics:(SCD_Struct_BW103*)arg3 ;
-(void)_serviceSDOFSceneMonitoringWithSampleBuffer:(opaqueCMSampleBufferRef)arg1 frameStatistics:(SCD_Struct_BW103*)arg2 flashModeForSceneMonitoring:(int)arg3 hdrModeForSceneMonitoring:(int)arg4 sisModeForSceneMonitoring:(int)arg5 ;
-(void)_serviceRetryStillImageCaptureUsingFrameStatistics:(SCD_Struct_BW103*)arg1 ;
...
-(int)_stillImageSceneTypeForFrameStatistics:(SCD_Struct_BW103*)arg1 flashMode:(int)arg2 hdrMode:(int)arg3 sisMode:(int)arg4 ;
...
-(unsigned)_stillImageCaptureInProgressSubstateForFrameStatistics:(SCD_Struct_BW103*)arg1 captureType:(int)arg2 masterCaptureStreamPortType:(id)arg3 stereoFusionCapture:(BOOL)arg4 ;
...
-(BOOL)_isLowLightSceneUsingFrameStatistics:(SCD_Struct_BW103*)arg1 ;
-(int)_copyAutofocusProcessorProperty:(CFStringRef)arg1 propertyValueOut:(void*)arg2 ;
-(int)_bravoCameraForOISOrSISCaptureType:(int)arg1 stereoFusionMode:(int)arg2 frameStatistics:(SCD_Struct_BW103*)arg3 zoomFactor:(float)arg4 stereoFusionLowerBoundZoomFactor:(float)arg5 stereoFusionUpperBoundZoomFactor:(float)arg6 ;
...
-(void)_fillOutSmartCameraDiagnostics:(id)arg1 usingSceneHints:(SCD_Struct_Fi72*)arg2 ;
...
-(void)_serviceAutoTorchNotification:(SCD_Struct_BW103*)arg1 sampleBuffer:(opaqueCMSampleBufferRef)arg2 ;
...
-(SCD_Struct_Fi73)deviceWhiteBalanceGains;
-(SCD_Struct_Fi73)grayWorldDeviceWhiteBalanceGains;
