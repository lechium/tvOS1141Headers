...
@interface FigIrisAutoTrimmer : NSObject {
	...
	SCD_Struct_Fi74 _captureMotionDelta;
	double _captureMotionDeltaPeriod;
	BOOL _haveCaptureMotionDelta;
	SCD_Struct_Fi74 _lastAttitude;
	SCD_Struct_Fi74 _lastDelta;
...
-(void)_processMotionSample:(const SCD_Struct_Fi74*)arg1 gravity:(const SCD_Struct_Fi73*)arg2 timestamp:(double)arg3 metadata:(id)arg4 ;
