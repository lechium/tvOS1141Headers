...
@class NSString, MFCancelationToken, NSObject, MFCoalescer, NSMutableArray, NSMutableSet, _MFLibrarySearchableIndexPendingRemovals, MFLazyCache, MFWeakSet, CSSearchableIndex;
