...
@class RTLocationAwarenessMetrics, RTMetricManager, RTAuthorizationManager, RTWiFiManager, CLLocation, NSDate, RTLocationAwarenessManagerConfig, RTLocationManager, NSObject, NSNumber, RTMotionActivityManager, RTPowerAssertion, RTInvocationDispatcher, NSMapTable;
...
@property (nonatomic,retain) NSObject*<OS_xpc_object> locationAwarenessXPCActivity;              //@synthesize locationAwarenessXPCActivity=_locationAwarenessXPCActivity - In the implementation block
...
-(NSObject*<OS_xpc_object>)locationAwarenessXPCActivity;
-(void)setLocationAwarenessXPCActivity:(NSObject*<OS_xpc_object>)arg1 ;
