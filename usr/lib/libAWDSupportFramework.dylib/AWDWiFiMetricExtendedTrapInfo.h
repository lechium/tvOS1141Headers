...
@interface AWDWiFiMetricExtendedTrapInfo : PBCodable <NSCopying> {
	...
	SCD_Struct_AW20* _backplanes;
	SCD_Struct_AW20* _bus;
	SCD_Struct_AW20* _deepSleeps;
	SCD_Struct_AW20* _macEnabs;
	SCD_Struct_AW20* _macs;
	SCD_Struct_AW20* _memoryDumps;
	SCD_Struct_AW20* _pcieQueueStates;
	SCD_Struct_AW20* _phyTxErrThreshs;
	SCD_Struct_AW20* _phys;
	SCD_Struct_AW20* _psmWDs;
	SCD_Struct_AW20* _signatures;
	SCD_Struct_AW20* _stackTraces;
	SCD_Struct_AW20* _ucodeErrors;
	SCD_Struct_AW20* _wlcStates;
	unsigned _sequence;
	SCD_Struct_AW5 _has;
