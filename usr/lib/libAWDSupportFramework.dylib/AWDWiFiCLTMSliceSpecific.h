...
@interface AWDWiFiCLTMSliceSpecific : PBCodable <NSCopying> {
	...
	SCD_Struct_AW20* _batteryVoltageBucketeds;
	SCD_Struct_AW20* _cltmIndexBucketeds;
	SCD_Struct_AW20* _numActiveChainsBucketeds;
	SCD_Struct_AW20* _ppmBucketeds;
	SCD_Struct_AW13* _temperatureBucketeds;
	SCD_Struct_AW20* _txDutyCycleBucketeds;
	SCD_Struct_AW13* _txPowerBackoffBucketeds;
