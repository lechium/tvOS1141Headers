...
@interface AWDWiFiMetricJoinTimeout : PBCodable <NSCopying> {
	...
	SCD_Struct_AW20* _associationStates;
	SCD_Struct_AW20* _channels;
	SCD_Struct_AW20* _joinClassificationInfos;
	SCD_Struct_AW20* _joinTargetClassificationInfos;
	SCD_Struct_AW20* _totalNumberOfJoinAttempts;
	unsigned _sequence;
	SCD_Struct_AW5 _has;
