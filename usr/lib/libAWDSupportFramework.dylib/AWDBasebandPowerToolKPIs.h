...
@interface AWDBasebandPowerToolKPIs : PBCodable <NSCopying> {
	...
	SCD_Struct_AW13* _armUtilityPDFs;
	SCD_Struct_AW13* _causeCodeBackgroundActivityARMUtilitys;
	SCD_Struct_AW13* _causeCodeBackgroundActivityDurations;
	SCD_Struct_AW13* _causeCodeCumulativeARMUtilitys;
	SCD_Struct_AW13* _causeCodeCumulativeDurations;
	SCD_Struct_AW13* _causeCodeMarginalCoverageARMUtilitys;
	SCD_Struct_AW13* _causeCodeMarginalCoverageDurations;
	SCD_Struct_AW13* _causeCodeOOSARMUtilitys;
	SCD_Struct_AW13* _causeCodeOOSDurations;
	SCD_Struct_AW13* _causeCodeRACHFailARMUtilitys;
	SCD_Struct_AW13* _causeCodeRACHFailDurations;
	SCD_Struct_AW13* _causeCodeStruckInDCHARMUtilitys;
	SCD_Struct_AW13* _causeCodeStruckInDCHDurations;
	SCD_Struct_AW13* _causeCodeTcXONotShuttingARMUtilitys;
	SCD_Struct_AW13* _causeCodeTcXONotShuttingDurations;
	SCD_Struct_AW13* _causeCodeUnknownARMUtilitys;
	SCD_Struct_AW13* _causeCodeUnknownDurations;
