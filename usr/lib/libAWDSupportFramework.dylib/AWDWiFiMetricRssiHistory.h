...
@interface AWDWiFiMetricRssiHistory : PBCodable <NSCopying> {
	...
	SCD_Struct_AW13* _bcnFrmsHistorys;
	SCD_Struct_AW13* _bcnPerHistorys;
	SCD_Struct_AW13* _fwTxFrmsHistorys;
	SCD_Struct_AW13* _fwTxPerHistorys;
	SCD_Struct_AW13* _rssiHistorys;
	SCD_Struct_AW13* _txFrmsHistorys;
	SCD_Struct_AW13* _txPerHistorys;
